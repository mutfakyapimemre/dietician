  ...
  <header class="header">
    <nav class="navbar navbar-expand-lg header-nav fixed-top">
      <div class="navbar-header">
        ...
        <nuxt-link to="/" tag="a" class="navbar-brand logo"><img src="/img/logo.png" class="img-fluid" alt="Logo"/>
        </nuxt-link>
      </div>
      <div class="main-menu-wrapper">
        <div class="menu-header">
          <nuxt-link to="/" tag="a" class="menu-logo"><img src="/img/logo.png" class="img-fluid" alt="Logo"/>
          </nuxt-link>
        ...
        <ul class="main-nav">
          ...
          <li>
            <nuxt-link to="/recipes" tag="a">Yemek Tarifleri</nuxt-link>
          </li>
          <li>
      ...
      <ul class="nav main-nav header-navbar-rht" v-if="isAuthenticated && userData !== null && userData !== undefined && userData !== ''">
        <li class="has-submenu nav-item my-auto py-auto">
          <a href="javascript:void(0)" class="my-auto py-auto">
            <span v-if="userData == null">Hesabım</span> <img v-bind:src="img_url+'/public/storage/'+(userData.status === 'dietician' ? userData.profile_photo : userData.img_url)" width="55" height="55" class="rounded-circle my-auto py-auto"
                                                              v-bind:alt="userData.name">
            <span class="my-auto py-auto" v-if="userData !== null">{{ userData.name }}</span>
            <i class="fa fa-chevron-down"></i></a>
          <ul class="submenu">
            <li class="">
              <nuxt-link to="/profile" tag="a" class="nav-link">Profil</nuxt-link>
            </li>
            <li>
              <nuxt-link to="/dietician-panel" tag="a" v-if="isAuthenticated && userData !== null && userData !== undefined && userData !== '' && userData.status ==='dietician'">Diyetisyen Paneli</nuxt-link>
            </li>
            <li class=""><a href="javascript:void(0)" @click.prevent="logout">Çıkış Yap</a></li>
          </ul>
        </li>
      </ul>
...
export default {
  ...
  data() {
    return {
      ...
      isAuthenticated: (Cookie.get("userData") !== null && Cookie.get("userData") !== undefined && Cookie.get("userData") !== "" ? JSON.parse(Base64.decode(Cookie.get("userData"))).api_token : null),
