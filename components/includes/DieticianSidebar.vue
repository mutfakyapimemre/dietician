        ...
        <div class="profile-det-info">
          ...
          <div class="clinic-details text-center justify-content-center">
            ...
            <ul
              ...
              v-if="
                userData.clinic_photos !== '' &&
                userData.clinic_photos !== null &&
                userData.clinic_photos !== undefined &&
                userData.clinic_photos.length > 0
              "
            >
              <li v-bind:key="index" v-for="(item, index) in userData.clinic_photos">
    ...
    <div class="dashboard-widget">
      <nav class="dashboard-menu">
        <ul>
          ...
          <nuxt-link to="/profile/food-recipes-list" tag="li" active-class="active">
            <a>
