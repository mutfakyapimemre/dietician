...
'<div class="profile-widget" style="width: 100%; display: inline-block;">'+
	...
	'<div class="pro-content">'+
		...
		'<ul class="available-info">'+
			'<li><i class="fa fa-map-marker-alt"></i> ' + marker.address + ' </li>'+
			'<li><i class="fa fa-clock"></i> ' + marker.next_available + '</li>'+
			'<li><i class="fa fa-money-bill-alt"></i> ' + marker.amount + '</li>'+
		'</ul>'+
	'</div>'+
'</div>';
