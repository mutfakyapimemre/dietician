...
/******/ 			var chunk = require("./" + ({"1":"layouts/admin","2":"layouts/adminlogin","3":"layouts/default","4":"layouts/dietician","5":"pages/auth/index","6":"pages/calorie/_id","7":"pages/calorie/index","8":"pages/criterias/index","9":"pages/dietician-login/index","10":"pages/dietician-panel/consultants/add/index","11":"pages/dietician-panel/consultants/ediet/add/_id","12":"pages/dietician-panel/consultants/index","13":"pages/dietician-panel/consultants/new-consultant/index","14":"pages/dietician-panel/consultants/update/_id","15":"pages/dietician-panel/index","16":"pages/dietician-panel/recipes/add/index","17":"pages/dietician-panel/recipes/index","18":"pages/dietician-panel/recipes/update/_id","19":"pages/dieticians/index","20":"pages/index","21":"pages/login/index","22":"pages/panel/blog-categories/add/index","23":"pages/panel/blog-categories/index","24":"pages/panel/blog-categories/update/_id","25":"pages/panel/criterias/add/index","26":"pages/panel/criterias/index","27":"pages/panel/criterias/update/_id","28":"pages/panel/dieticians/add/index","29":"pages/panel/dieticians/index","30":"pages/panel/dieticians/update/_id","31":"pages/panel/diseases/add/index","32":"pages/panel/diseases/index","33":"pages/panel/diseases/update/_id","34":"pages/panel/e-diet-foods/add/index","35":"pages/panel/e-diet-foods/index","36":"pages/panel/e-diet-foods/update/_id","37":"pages/panel/e-diet/add/index","38":"pages/panel/e-diet/index","39":"pages/panel/e-diet/update/_id","40":"pages/panel/exercise-categories/add/index","41":"pages/panel/exercise-categories/index","42":"pages/panel/exercise-categories/update/_id","43":"pages/panel/exercises/add/index","44":"pages/panel/exercises/index","45":"pages/panel/exercises/update/_id","46":"pages/panel/index","47":"pages/panel/nutrients/add/index","48":"pages/panel/nutrients/index","49":"pages/panel/nutrients/update/_id","50":"pages/panel/recipe-categories/add/index","51":"pages/panel/recipe-categories/index","52":"pages/panel/recipe-categories/update/_id","53":"pages/panel/recipes/add/index","54":"pages/panel/recipes/index","55":"pages/panel/recipes/update/_id","56":"pages/panel/settings/add/index","57":"pages/panel/settings/index","58":"pages/panel/settings/update/_id","59":"pages/panel/slides/add/index","60":"pages/panel/slides/index","61":"pages/panel/slides/update/_id","62":"pages/panel/users/add/index","63":"pages/panel/users/index","64":"pages/panel/users/update/_id","65":"pages/profile/dietician-applyment/_id","66":"pages/profile/index","67":"pages/profile/password-update","68":"pages/profile/social-media","69":"pages/recipe-categories/_id","70":"pages/recipe-categories/index","71":"pages/recipes/_id","72":"pages/search"}[chunkId]||chunkId) + ".js");
...
framework_Vuetify.version = "2.4.4";
...
/* harmony import */ var js_base64__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
...
const mutations = {
  ...
  clearUserData(state) {
    js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.remove("userData");
    js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.remove("isAdmin");
    js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.remove("expiresIn");
...
const actions = {
  async nuxtServerInit(vuexContext, context) {
    return await this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "home").then(response => {
  ...
  initLogin(vuexContext, req) {
    ...
    if (req) {
      ...
      if (userData) {
        userData = JSON.parse(js_base64__WEBPACK_IMPORTED_MODULE_1__["Base64"].decode(userData.split("=")[1]));
      }

      expiresIn = expiresIn = new Date().getTime() + 24 * 60 * 60;
    } else {
      if ((js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.get("userData") === null || js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.get("userData") === '' || js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.get("userData") === undefined) && localStorage.getItem("userData") !== null && localStorage.getItem("userData") !== undefined && localStorage.getItem("userData") !== "") {
        js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.remove("userData");
        js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.remove("isAdmin");
        js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.remove("expiresIn");
        localStorage.removeItem("userData");
      ...
      if (localStorage.getItem("userData") !== undefined && localStorage.getItem("userData") !== null && localStorage.getItem("userData") !== "") {
        userData = JSON.parse(js_base64__WEBPACK_IMPORTED_MODULE_1__["Base64"].decode(localStorage.getItem("userData")));
      } else {
        userData = {};
      }
    }
  ...
  LoginUser(vuexContext, loginData) {
    ...
    return this.$axios.post("https://api.klinikdiyetisyen.com/api/" + loginLink, loginData, {
      json: true,
      ...
      if (response.data.user !== undefined && response.data.user !== "" && response.data.user !== null) {
        ...
        js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.set("expiresIn", expiresIn);
        js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.set("userData", js_base64__WEBPACK_IMPORTED_MODULE_1__["Base64"].encode(JSON.stringify(response.data.user)));
        js_cookie__WEBPACK_IMPORTED_MODULE_0___default.a.set("isAdmin", response.data.user.status);
        /**
         * Set Local Storage
         */

        localStorage.setItem("expiresIn", expiresIn);
        localStorage.setItem("userData", js_base64__WEBPACK_IMPORTED_MODULE_1__["Base64"].encode(JSON.stringify(response.data.user)));
  ...
  RegisterUser(vuexContext, registerData) {
    ...
    return this.$axios.post("https://api.klinikdiyetisyen.com/api/" + registerLink, registerData, {
      json: true,
      withCredentials: false,
      mode: 'no-cors',
      headers: {
  ...
  getNutrients(vuexContext, context) {
    ...
    return this.$axios.get("https://api.klinikdiyetisyen.com/api/" + nutrientsURL).then(response => {
  ...
  getRecipeCategories(vuexContext, context) {
    ...
    return this.$axios.get("https://api.klinikdiyetisyen.com/api/" + recipeCategoriesURL).then(response => {
      if (response.data !== null && response.data !== undefined && response.data !== "") {
  ...
  getCriterias(vuexContext, context) {
    ...
    return this.$axios.get("https://api.klinikdiyetisyen.com/api/" + criteriasURL).then(response => {
      if (response.data !== null && response.data !== undefined && response.data !== "") {
  ...
  getDoctors(vuexContext, context) {
    ...
    return this.$axios.get("https://api.klinikdiyetisyen.com/api/" + doctorsURL).then(response => {
      if (response.data !== null && response.data !== undefined && response.data !== "") {
  ...
  getSearchs(vuexContext, context) {
    ...
    return this.$axios.get("https://api.klinikdiyetisyen.com/api/" + searchsURL).then(response => {
      if (response.data !== null && response.data !== undefined && response.data !== "") {
...
var ufo_ = __webpack_require__(6);
...
const middleware = {};
middleware['admin'] = __webpack_require__(24);
middleware['admin'] = middleware['admin'].default || middleware['admin'];
middleware['auth'] = __webpack_require__(25);
middleware['auth'] = middleware['auth'].default || middleware['auth'];
middleware['dietician'] = __webpack_require__(26);
middleware['dietician'] = middleware['dietician'].default || middleware['dietician'];
middleware['guest'] = __webpack_require__(27);
middleware['guest'] = middleware['guest'].default || middleware['guest'];
middleware['notadmin'] = __webpack_require__(28);
middleware['notadmin'] = middleware['notadmin'].default || middleware['notadmin'];
middleware['session-control'] = __webpack_require__(29);
...
const _801c42ca = () => interopDefault(__webpack_require__.e(/* import() | pages/auth/index */ 5).then(__webpack_require__.bind(null, 190)));

const _12665cc4 = () => interopDefault(__webpack_require__.e(/* import() | pages/calorie/index */ 7).then(__webpack_require__.bind(null, 191)));

const _be664a86 = () => interopDefault(__webpack_require__.e(/* import() | pages/criterias/index */ 8).then(__webpack_require__.bind(null, 192)));

const _6fb708e6 = () => interopDefault(__webpack_require__.e(/* import() | pages/dietician-login/index */ 9).then(__webpack_require__.bind(null, 188)));

const _6fe57bdc = () => interopDefault(__webpack_require__.e(/* import() | pages/dietician-panel/index */ 15).then(__webpack_require__.bind(null, 193)));

const _a42b9890 = () => interopDefault(__webpack_require__.e(/* import() | pages/dieticians/index */ 19).then(__webpack_require__.bind(null, 194)));

const _458208a8 = () => interopDefault(__webpack_require__.e(/* import() | pages/login/index */ 21).then(__webpack_require__.bind(null, 195)));

const _456acf2d = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/index */ 46).then(__webpack_require__.bind(null, 196)));

const _805b1eb0 = () => interopDefault(__webpack_require__.e(/* import() | pages/profile/index */ 66).then(__webpack_require__.bind(null, 197)));

const _3c330696 = () => interopDefault(__webpack_require__.e(/* import() | pages/recipe-categories/index */ 70).then(__webpack_require__.bind(null, 198)));

const _84253b72 = () => interopDefault(__webpack_require__.e(/* import() | pages/search */ 72).then(__webpack_require__.bind(null, 199)));

const _837e302c = () => interopDefault(__webpack_require__.e(/* import() | pages/dietician-panel/consultants/index */ 12).then(__webpack_require__.bind(null, 189)));

const _72f0be7d = () => interopDefault(__webpack_require__.e(/* import() | pages/dietician-panel/recipes/index */ 17).then(__webpack_require__.bind(null, 200)));

const _67b43e00 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/blog-categories/index */ 23).then(__webpack_require__.bind(null, 201)));

const _09fc365a = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/criterias/index */ 26).then(__webpack_require__.bind(null, 202)));

const _cb53273c = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/dieticians/index */ 29).then(__webpack_require__.bind(null, 203)));

const _468fbd16 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/diseases/index */ 32).then(__webpack_require__.bind(null, 204)));

const _5d3a8ad1 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/e-diet/index */ 38).then(__webpack_require__.bind(null, 205)));

const _7a8f80c9 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/e-diet-foods/index */ 35).then(__webpack_require__.bind(null, 206)));

const _c02d1f94 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/exercise-categories/index */ 41).then(__webpack_require__.bind(null, 207)));

const _ecf7cc68 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/exercises/index */ 44).then(__webpack_require__.bind(null, 208)));

const _3c17b95b = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/nutrients/index */ 48).then(__webpack_require__.bind(null, 209)));

const _08c0caa8 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/recipe-categories/index */ 51).then(__webpack_require__.bind(null, 210)));

const _357e807c = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/recipes/index */ 54).then(__webpack_require__.bind(null, 211)));

const _0c063bea = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/settings/index */ 57).then(__webpack_require__.bind(null, 212)));

const _cca672ea = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/slides/index */ 60).then(__webpack_require__.bind(null, 213)));

const _33b1e5bf = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/users/index */ 63).then(__webpack_require__.bind(null, 214)));

const _38ab0a11 = () => interopDefault(__webpack_require__.e(/* import() | pages/profile/password-update */ 67).then(__webpack_require__.bind(null, 215)));

const _56f3b61e = () => interopDefault(__webpack_require__.e(/* import() | pages/profile/social-media */ 68).then(__webpack_require__.bind(null, 216)));

const _048a3a29 = () => interopDefault(__webpack_require__.e(/* import() | pages/dietician-panel/consultants/add/index */ 10).then(__webpack_require__.bind(null, 187)));

const _75081aa2 = () => interopDefault(__webpack_require__.e(/* import() | pages/dietician-panel/consultants/new-consultant/index */ 13).then(__webpack_require__.bind(null, 217)));

const _0d288776 = () => interopDefault(__webpack_require__.e(/* import() | pages/dietician-panel/recipes/add/index */ 16).then(__webpack_require__.bind(null, 218)));

const _11637ed3 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/blog-categories/add/index */ 22).then(__webpack_require__.bind(null, 219)));

const _529fe6e0 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/criterias/add/index */ 25).then(__webpack_require__.bind(null, 220)));

const _7a0cc0b1 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/dieticians/add/index */ 28).then(__webpack_require__.bind(null, 221)));

const _404dc07d = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/diseases/add/index */ 31).then(__webpack_require__.bind(null, 222)));

const _b3b956ac = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/e-diet-foods/add/index */ 34).then(__webpack_require__.bind(null, 223)));

const _571560bc = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/e-diet/add/index */ 37).then(__webpack_require__.bind(null, 224)));

const _feb1fd46 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/exercise-categories/add/index */ 40).then(__webpack_require__.bind(null, 225)));

const _2b7634f2 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/exercises/add/index */ 43).then(__webpack_require__.bind(null, 226)));

const _2221a758 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/nutrients/add/index */ 47).then(__webpack_require__.bind(null, 227)));

const _7b96f0a7 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/recipe-categories/add/index */ 50).then(__webpack_require__.bind(null, 228)));

const _9120ed5e = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/recipes/add/index */ 53).then(__webpack_require__.bind(null, 229)));

const _3e0d33ae = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/settings/add/index */ 56).then(__webpack_require__.bind(null, 230)));

const _7a955828 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/slides/add/index */ 59).then(__webpack_require__.bind(null, 231)));

const _cab0cd18 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/users/add/index */ 62).then(__webpack_require__.bind(null, 232)));

const _3e4dbb6a = () => interopDefault(__webpack_require__.e(/* import() | pages/dietician-panel/consultants/ediet/add/_id */ 11).then(__webpack_require__.bind(null, 233)));

const _730afaa9 = () => interopDefault(__webpack_require__.e(/* import() | pages/dietician-panel/consultants/update/_id */ 14).then(__webpack_require__.bind(null, 234)));

const _7e3656fc = () => interopDefault(__webpack_require__.e(/* import() | pages/dietician-panel/recipes/update/_id */ 18).then(__webpack_require__.bind(null, 235)));

const _015a4b3f = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/blog-categories/update/_id */ 24).then(__webpack_require__.bind(null, 236)));

const _30aa365c = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/criterias/update/_id */ 27).then(__webpack_require__.bind(null, 237)));

const _a44d75be = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/dieticians/update/_id */ 30).then(__webpack_require__.bind(null, 238)));

const _a08f8256 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/diseases/update/_id */ 33).then(__webpack_require__.bind(null, 239)));

const _04953048 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/e-diet-foods/update/_id */ 36).then(__webpack_require__.bind(null, 240)));

const _befad760 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/e-diet/update/_id */ 39).then(__webpack_require__.bind(null, 241)));

const _7a8719f5 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/exercise-categories/update/_id */ 42).then(__webpack_require__.bind(null, 242)));

const _44a5bb0b = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/exercises/update/_id */ 45).then(__webpack_require__.bind(null, 243)));

const _0861335a = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/nutrients/update/_id */ 49).then(__webpack_require__.bind(null, 244)));

const _44d5d82a = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/recipe-categories/update/_id */ 52).then(__webpack_require__.bind(null, 245)));

const _1ccf9081 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/recipes/update/_id */ 55).then(__webpack_require__.bind(null, 246)));

const _24814ea9 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/settings/update/_id */ 58).then(__webpack_require__.bind(null, 247)));

const _8338c6ec = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/slides/update/_id */ 61).then(__webpack_require__.bind(null, 248)));

const _beccf684 = () => interopDefault(__webpack_require__.e(/* import() | pages/panel/users/update/_id */ 64).then(__webpack_require__.bind(null, 249)));

const _34145226 = () => interopDefault(__webpack_require__.e(/* import() | pages/profile/dietician-applyment/_id */ 65).then(__webpack_require__.bind(null, 250)));

const _4aa67fa8 = () => interopDefault(__webpack_require__.e(/* import() | pages/calorie/_id */ 6).then(__webpack_require__.bind(null, 251)));

const _66449304 = () => interopDefault(__webpack_require__.e(/* import() | pages/recipe-categories/_id */ 69).then(__webpack_require__.bind(null, 252)));

const _2a5374d8 = () => interopDefault(__webpack_require__.e(/* import() | pages/recipes/_id */ 71).then(__webpack_require__.bind(null, 253)));

const _219e6783 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 20).then(__webpack_require__.bind(null, 254))); // TODO: remove in Nuxt 3
...
const routerOptions = {
  ...
  routes: [{
    ...
    path: "/panel/dieticians/add",
    component: _7a0cc0b1,
    name: "panel-dieticians-add"
  }, {
...
var iziToast = __webpack_require__(32);

// EXTERNAL MODULE: ./node_modules/vue2-dropzone/dist/vue2Dropzone.min.css
var vue2Dropzone_min = __webpack_require__(33);
...
const _77068119 = () => __webpack_require__.e(/* import() | layouts/admin */ 1).then(__webpack_require__.bind(null, 255)).then(m => sanitizeComponent(m.default || m));

const _4eb135f0 = () => __webpack_require__.e(/* import() | layouts/adminlogin */ 2).then(__webpack_require__.bind(null, 256)).then(m => sanitizeComponent(m.default || m));

const _6f6c098b = () => __webpack_require__.e(/* import() | layouts/default */ 3).then(__webpack_require__.bind(null, 257)).then(m => sanitizeComponent(m.default || m));

const _6225df5c = () => __webpack_require__.e(/* import() | layouts/dietician */ 4).then(__webpack_require__.bind(null, 186)).then(m => sanitizeComponent(m.default || m));

let resolvedLayouts = {};
const layouts = {
  "_admin": _77068119,
  "_adminlogin": _4eb135f0,
  "_default": _6f6c098b,
  "_dietician": _6225df5c
};
...
// CONCATENATED MODULE: ./.nuxt/nuxt-izitoast.plugin.43e29816.js
let izitoast;
...
/* harmony default export */ var nuxt_izitoast_plugin_43e29816 = (function (ctx, inject, c, d) {
  izitoast.settings({});
...
/* Plugins */
 ...
 // Source: .\\lib.module.plugin.66164b6a.js (mode: 'client')
 ...
 // Source: ..\\plugins\\vuetify (mode: 'client')

 // Source: ..\\plugins\\axios (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_izitoast_plugin_43e29816 === 'function') {
    await nuxt_izitoast_plugin_43e29816(app.context, inject);
  }
