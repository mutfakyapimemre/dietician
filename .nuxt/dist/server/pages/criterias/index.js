...
/* harmony default export */ var criteriasvue_type_script_lang_js_ = ({
  ...
  methods: {
    getCriterias(param) {
      if (this.search !== null) {
        this.$store.dispatch("getCriterias", {
          criteriasURL: "criteria?page=" + this.pagination.current + "&search=" + decodeURIComponent(this.search)
        }).then(response => {
...
// CONCATENATED MODULE: ./pages/criterias/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_criteriasvue_type_script_lang_js_ = (criteriasvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/criterias/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_criteriasvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
