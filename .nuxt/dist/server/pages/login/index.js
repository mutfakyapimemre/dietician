...
var errors = ref.errors;
return [_c('v-text-field',{attrs:{"label":"Şifreniz","hide-details":"auto","type":"password","name":"password"},model:{value:(_vm.password),callback:function ($$v) {_vm.password=$$v},expression:"password"}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"text-right"},[_c('nuxt-link',{staticClass:"forgot-link",attrs:{"to":"/forgot-password","tag":"a"}},[_vm._v("Şifremi Unuttum.")])],1),_vm._v(" "),_c('button',{staticClass:"btn btn-green-light login-btn",attrs:{"type":"submit"}},[_vm._v("\n                          Giriş Yap\n                        ")])])]}}])})],1),_vm._v(" "),_c('div',{staticClass:"tab-pane fade",attrs:{"id":"register","role":"tabpanel","aria-labelledby":"register-tab"}},[_c('div',{staticClass:"login-header"},[_c('h3',{staticClass:"font-weight-bold"},[_vm._v("\n                        Diyetisyen Klinik\n                        "),_c('small',{staticClass:"font-weight-normal"},[_vm._v("Kullanıcı Kaydı")]),_vm._v(" "),_c('nuxt-link',{attrs:{"to":"/dietician-login","tag":"a"}},[_vm._v("Diyetisyen Misiniz? Hemen Kayıt Olun")])],1)]),_vm._v(" "),_c('ValidationObserver',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
var handleSubmit = ref.handleSubmit;
return [_c('form',{ref:"userRegister",attrs:{"enctype":"multipart/form-data"},on:{"submit":function($event){$event.preventDefault();return handleSubmit(_vm.onRegister)}}},[_c('div',{staticClass:"form-group form-focus"},[_c('ValidationProvider',{attrs:{"name":"Adınız ve Soyadınız","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('v-text-field',{attrs:{"label":"Adınız ve Soyadınız","hide-details":"auto","type":"text","name":"name"},model:{value:(_vm.name),callback:function ($$v) {_vm.name=$$v},expression:"name"}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"form-group form-focus"},[_c('ValidationProvider',{attrs:{"name":"Email Adresiniz","rules":"required|email"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('v-text-field',{attrs:{"label":"Email Adresiniz","hide-details":"auto","type":"email","name":"email"},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"form-group form-focus"},[_c('ValidationProvider',{attrs:{"name":"Telefon Numaranız","rules":"required|phone"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('v-text-field',{attrs:{"label":"Telefon Numaranız","hide-details":"auto","type":"text","name":"phone"},model:{value:(_vm.phone),callback:function ($$v) {_vm.phone=$$v},expression:"phone"}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"form-group form-focus"},[_c('ValidationProvider',{attrs:{"name":"Şifreniz","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('v-text-field',{attrs:{"label":"Şifreniz","hide-details":"auto","type":"password","name":"password"},model:{value:(_vm.password),callback:function ($$v) {_vm.password=$$v},expression:"password"}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"form-group form-focus"},[_c('ValidationProvider',{attrs:{"name":"Tekrar Şifreniz","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('v-text-field',{attrs:{"label":"Şifreniz","hide-details":"auto","type":"password","name":"password_confirmation"},model:{value:(_vm.password_confirmation),callback:function ($$v) {_vm.password_confirmation=$$v},expression:"password_confirmation"}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])]}}],null,true)})],1),_vm._v(" "),_c('button',{staticClass:"btn btn-green-light login-btn",attrs:{"type":"submit"}},[_vm._v("\n                          Kayıt Ol\n                        ")])])]}}])})],1)])])])])])])])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/login/index.vue?vue&type=template&id=dac66fcc&
...
installComponents_default()(component, {VApp: VApp["a" /* default */],VTextField: VTextField["a" /* default */]})
