...
// CONCATENATED MODULE: ./pages/panel/exercises/update/_id.vue?vue&type=template&id=558d07a6&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/exercises/update/_id.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      loading: false,
      options: {
        url: "https://api.klinikdiyetisyen.com/api/" + "panel/exercises/create-file/" + this.$route.params.id,
        headers: {
  ...
  async asyncData({
    ...
    try {
      const {
        data
      } = await $axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/exercises/update/" + params.id);
      return data;
    } catch (e) {
      error({
        message: "Egzersiz Bilgisi Bulunamadı.",
        statusCode: 404
      });
    }
  },
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/datatables/${urlParam}?table=exercises_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=exercise_id&where_value=${this.data._id.$oid}&joins=exercises_file`, {
        json: true,
    ...
    editExercises() {
      ...
      this.$axios.post("https://api.klinikdiyetisyen.com/api/" + "panel/exercises/update/" + this.data._id.$oid, formData, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
...
// CONCATENATED MODULE: ./pages/panel/exercises/update/_id.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/panel/exercises/update/_id.vue
