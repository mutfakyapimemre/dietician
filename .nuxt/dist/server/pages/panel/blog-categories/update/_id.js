...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/blog-categories/update/_id.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    try {
      const {
        data
      } = await $axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/criteria/update/" + params.id);
      return data;
    } catch (e) {
      error({
        message: "Ölçüt Bilgisi Bulunamadı.",
        statusCode: 404
      });
    }
  },
  ...
  methods: {
    ...
    editCriterias() {
      ...
      this.$axios.post("https://api.klinikdiyetisyen.com/api/" + "panel/criteria/update/" + this.data._id.$oid, formData, {
        json: true,
...
// CONCATENATED MODULE: ./pages/panel/blog-categories/update/_id.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/panel/blog-categories/update/_id.vue
