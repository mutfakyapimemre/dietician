...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/blog-categories/index.vue?vue&type=template&id=def2935e&
...
return [_c('v-layout',{attrs:{"justify-center":""}},[_c('v-switch',{key:item.id,staticClass:"d-flex justify-content-center mx-auto px-auto text-center",attrs:{"color":"success"},on:{"click":function($event){return _vm.isActiveSetter(item.id)}},model:{value:(item.isActive),callback:function ($$v) {_vm.$set(item, "isActive", $$v)},expression:"item.isActive"}})],1)]}},{key:"item.actions",fn:function(ref){
                  var item = ref.item;
return [_c('v-icon',{staticClass:"mr-2",attrs:{"small":""},on:{"click":function($event){return _vm.editData(item.id)}}},[_vm._v("\n                mdi-pencil\n              ")]),_vm._v(" "),_c('v-icon',{attrs:{"small":""},on:{"click":function($event){return _vm.deleteData(item.id)}}},[_vm._v("\n                mdi-delete\n              ")])]}}],null,true)})],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"12","lg":"3"}},[_c('v-select',{attrs:{"items":_vm.pageSizes,"label":"Sayfada Görüntüleme Sayısı"},on:{"change":_vm.handlePageSizeChange},model:{value:(_vm.pageSize),callback:function ($$v) {_vm.pageSize=$$v},expression:"pageSize"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","lg":"9"}},[_c('v-pagination',{attrs:{"length":_vm.totalPages,"total-visible":"7","next-icon":"mdi-menu-right","prev-icon":"mdi-menu-left"},on:{"input":_vm.handlePageChange},model:{value:(_vm.page),callback:function ($$v) {_vm.page=$$v},expression:"page"}})],1)],1)],1)])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/panel/blog-categories/index.vue?vue&type=template&id=def2935e&
