...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/recipes/index.vue?vue&type=template&id=12213cac&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',[_c('div',{staticClass:"main-wrapper"},[_c('div',{staticClass:"page-wrapper"},[_c('div',{staticClass:"content container-fluid"},[_c('div',{staticClass:"page-header"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12"},[_c('h3',{staticClass:"page-title"},[_vm._v("Yemek Tarifleri")]),_vm._v(" "),_c('ul',{staticClass:"breadcrumb"},[_c('li',{staticClass:"breadcrumb-item"},[_c('nuxt-link',{attrs:{"to":"/panel","tag":"a"}},[_vm._v("Anasayfa")])],1),_vm._v(" "),_c('li',{staticClass:"breadcrumb-item active"},[_vm._v("Yemek Tarifleri")])])])])]),_vm._v(" "),_c('v-card',{attrs:{"tile":""}},[_c('v-card-title',{staticClass:"d-flex justify-content-between"},[_c('span',{staticClass:"justify-content-center flex-grow-1"},[_c('v-text-field',{staticClass:"my-auto py-auto",attrs:{"label":"Arama Yapın..."},on:{"keyup":function($event){$event.preventDefault();_vm.page = 1;
                  _vm.retrieveData('get-by-search');}},model:{value:(_vm.searchTitle),callback:function ($$v) {_vm.searchTitle=$$v},expression:"searchTitle"}})],1),_vm._v(" "),_c('span',{staticClass:"justify-content-end flex-shrink-1"},[_c('nuxt-link',{staticClass:"float-right btn btn-info-light ml-3 my-auto py-auto",attrs:{"to":"/panel/recipes/add","tag":"a"}},[_c('i',{staticClass:"fa fa-plus"}),_vm._v(" Ekle\n              ")])],1)]),_vm._v(" "),_c('v-data-table',{attrs:{"headers":_vm.headers,"items":_vm.data,"disable-pagination":"","hide-default-footer":true},scopedSlots:_vm._u([{key:"item.img_url",fn:function(ref){
                  var item = ref.item;
...
// CONCATENATED MODULE: ./pages/panel/recipes/index.vue?vue&type=template&id=12213cac&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/recipes/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var recipesvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/recipes/${urlParam}?table=recipes&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name`, {
        json: true,
    ...
    deleteData(id) {
      this.$axios.delete("https://api.klinikdiyetisyen.com/api/" + "panel/recipes/delete/" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/is-active-setter?table=recipes&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
...
// CONCATENATED MODULE: ./pages/panel/recipes/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var panel_recipesvue_type_script_lang_js_ = (recipesvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/panel/recipes/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  panel_recipesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
