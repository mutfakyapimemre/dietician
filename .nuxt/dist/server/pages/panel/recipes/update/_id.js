...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/recipes/update/_id.vue?vue&type=template&id=1bb81bc3&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',[_c('div',{staticClass:"main-wrapper"},[_c('div',{staticClass:"page-wrapper"},[_c('div',{staticClass:"content container-fluid"},[_c('div',{staticClass:"page-header"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12"},[_c('h3',{staticClass:"page-title"},[_vm._v("Yemek Tarifi Düzenle")]),_vm._v(" "),_c('ul',{staticClass:"breadcrumb"},[_c('li',{staticClass:"breadcrumb-item"},[_c('nuxt-link',{attrs:{"to":"/panel","tag":"a"}},[_vm._v("Anasayfa")])],1),_vm._v(" "),_c('li',{staticClass:"breadcrumb-item active"},[_vm._v("Yemek Tarifi Düzenle")])])])])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-12"},[_c('div',{staticClass:"card"},[_c('div',{staticClass:"card-header"},[_c('h4',{staticClass:"card-title"},[_vm._v("Yemek Tarifi Düzenle")])]),_vm._v(" "),_c('div',{staticClass:"card-body"},[_c('ValidationObserver',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
var handleSubmit = ref.handleSubmit;
return [_c('form',{ref:"recipesForm",attrs:{"enctype":"multipart/form-data"},on:{"submit":function($event){$event.preventDefault();return handleSubmit(_vm.editRecipes)}}},[_c('v-stepper',{model:{value:(_vm.e1),callback:function ($$v) {_vm.e1=$$v},expression:"e1"}},[_c('v-stepper-header',[_c('v-stepper-step',{attrs:{"complete":_vm.e1 > 1,"step":"1"}},[_vm._v("\n                          Yemek Tarifi Bilgileri\n                        ")]),_vm._v(" "),_c('v-divider'),_vm._v(" "),_c('v-stepper-step',{attrs:{"complete":_vm.e1 > 2,"step":"2"}},[_vm._v("\n                          Yemek Tarifi Görselleri\n                        ")]),_vm._v(" "),_c('v-divider'),_vm._v(" "),_c('v-stepper-step',{attrs:{"complete":_vm.e1 > 3,"step":"3"}},[_vm._v("\n                          Kapak Fotoğrafı Seçimi\n                        ")])],1),_vm._v(" "),_c('v-stepper-items',[_c('v-stepper-content',{attrs:{"step":"1"}},[_c('ValidationProvider',{attrs:{"name":"Yemek Tarifi Adı","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"title"}},[_vm._v("Yemek Tarifi Adı")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.data.name),expression:"data.name"}],staticClass:"form-control",attrs:{"id":"title","type":"text","name":"name"},domProps:{"value":(_vm.data.name)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.data, "name", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Yemek Tarifi Türü","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"category_id"}},[_vm._v("Yemek Tarifi Türü")]),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.data.category_id),expression:"data.category_id"}],staticClass:"form-control",attrs:{"name":"category_id","id":"category_id"},on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.$set(_vm.data, "category_id", $event.target.multiple ? $$selectedVal : $$selectedVal[0])}}},[_c('option',{attrs:{"selected":""},domProps:{"value":null}},[_vm._v("\n                                  Yemek Tarifi Türü Seçiniz.\n                                ")]),_vm._v(" "),_vm._l((_vm.data.categories),function(category,index){return _c('option',{key:index,domProps:{"value":category._id.$oid}},[_vm._v("\n                                  "+_vm._s(category.name)+"\n                                ")])})],2),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Yemek Tarifi Porsiyon Sayısı","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"portion"}},[_vm._v("Yemek Tarifi Porsiyon Sayısı")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.data.portion),expression:"data.portion"}],staticClass:"form-control",attrs:{"id":"portion","type":"text","name":"portion"},domProps:{"value":(_vm.data.portion)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.data, "portion", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Yemek Tarifi Hazırlık Süresi","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"prepare_time"}},[_vm._v("Yemek Tarifi Hazırlık Süresi")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.data.prepare_time),expression:"data.prepare_time"}],staticClass:"form-control",attrs:{"id":"prepare_time","type":"text","name":"prepare_time"},domProps:{"value":(_vm.data.prepare_time)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.data, "prepare_time", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Yemek Tarifi Pişirme Süresi","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"cooking_time"}},[_vm._v("Yemek Tarifi Pişirme Süresi")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.data.cooking_time),expression:"data.cooking_time"}],staticClass:"form-control",attrs:{"id":"cooking_time","type":"text","name":"cooking_time"},domProps:{"value":(_vm.data.cooking_time)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.data, "cooking_time", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Yemek Tarifi Kalorisi","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"calorie"}},[_vm._v("Yemek Tarifi Kalorisi (Porsiyon -\n                                Gram)")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.data.calorie),expression:"data.calorie"}],staticClass:"form-control",attrs:{"id":"calorie","type":"text","name":"calorie"},domProps:{"value":(_vm.data.calorie)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.data, "calorie", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Yemek Tarifi Açıklaması","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"description"}},[_vm._v("Yemek Tarifi Açıklaması")]),_vm._v(" "),_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(_vm.data.description),expression:"data.description"}],staticClass:"form-control",attrs:{"id":"description","name":"description"},domProps:{"value":(_vm.data.description)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.data, "description", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('v-tabs',{attrs:{"background-color":"primary","dark":""},model:{value:(_vm.tab),callback:function ($$v) {_vm.tab=$$v},expression:"tab"}},_vm._l((_vm.items),function(item){return _c('v-tab',{key:item.tab},[_vm._v("\n                              "+_vm._s(item.tab)+"\n                            ")])}),1),_vm._v(" "),_c('v-tabs-items',{model:{value:(_vm.tab),callback:function ($$v) {_vm.tab=$$v},expression:"tab"}},[_c('v-tab-item',{attrs:{"eager":""}},[_c('v-card',{attrs:{"flat":""}},[(
...
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":'vitaminType' + index}},[_vm._v("Besin Değeri Türü")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input.type),expression:"input.type"}],staticClass:"form-control",attrs:{"id":'vitaminType' + index,"type":"text","name":"vitaminType[]"},domProps:{"value":(input.type)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input, "type", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2 py-auto my-auto text-center align-bottom"},[_c('button',{staticClass:"btn btn-lg btn-primary text-white rounded-circle align-bottom text-center",attrs:{"role":"button"},on:{"click":function($event){$event.preventDefault();return _vm.cloneProperty($event)}}},[_c('i',{staticClass:"fa fa-plus"})]),_vm._v(" "),(_vm.data.values.length > 1)?_c('button',{staticClass:"btn btn-lg btn-danger text-white rounded-circle align-bottom text-center",attrs:{"role":"button"},on:{"click":function($event){$event.preventDefault();return _vm.removeProperty(index)}}},[_c('i',{staticClass:"fa fa-times"})]):_vm._e()])])}),0):_vm._e()],1)],1),_vm._v(" "),_c('v-tab-item',{attrs:{"eager":""}},[_c('v-card',{attrs:{"flat":""}},[(
                                  ...
                                  )?_c('v-card-text',_vm._l((_vm.data.recipes_criteria_values),function(input,index){return _c('div',{key:index,staticClass:"row"},[_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4"},[_c('ValidationProvider',{attrs:{"name":"Ölçüt Değeri Adı","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":'criteria' + index}},[_vm._v("Ölçüt Değeri Adı")]),_vm._v(" "),_c('select',{staticClass:"form-control",attrs:{"name":"criteriaName[]","id":'criteria' + index}},[_c('option',{attrs:{"value":"","selected":""}},[_vm._v("\n                                              Ölçüt Seçiniz\n                                            ")]),_vm._v(" "),_vm._l((_vm.data.criterias),function(criteria,index){return _c('option',{key:index,domProps:{"value":criteria.name,"selected":criteria.name === input.title}},[_vm._v("\n                                              "+_vm._s(criteria.name)+"\n                                            ")])})],2),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2"},[_c('ValidationProvider',{attrs:{"name":"Ölçüt Değeri","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":'criteriaValue' + index}},[_vm._v("Ölçüt Değeri")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input.value),expression:"input.value"}],staticClass:"form-control",attrs:{"id":'criteriaValue' + index,"type":"text","name":"criteriaValue[]"},domProps:{"value":(input.value)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input, "value", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2"},[_c('ValidationProvider',{attrs:{"name":"Ölçüt Değeri Türü","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":'criteriaType' + index}},[_vm._v("Ölçüt Değeri Türü")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input.type),expression:"input.type"}],staticClass:"form-control",attrs:{"id":'criteriaType' + index,"type":"text","name":"criteriaType[]"},domProps:{"value":(input.type)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input, "type", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2"},[_c('ValidationProvider',{attrs:{"name":"Malzeme Besini","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":'criteriaNutrient' + index}},[_vm._v("Malzeme Besini")]),_vm._v(" "),_c('select',{directives:[{name:"model",rawName:"v-model",value:(input.recipe_criteria_id),expression:"input.recipe_criteria_id"}],staticClass:"form-control",attrs:{"name":"criteriaNutrient[]","id":'criteriaNutrient' + index},on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.$set(input, "recipe_criteria_id", $event.target.multiple ? $$selectedVal : $$selectedVal[0])}}},[_c('option',{attrs:{"value":"","selected":""}},[_vm._v("\n                                              Malzeme Besini Seçiniz.\n                                            ")]),_vm._v(" "),_vm._l((_vm.data.nutrients),function(nutrient,index){return _c('option',{key:index,domProps:{"value":nutrient._id.$oid,"selected":nutrient._id.$oid ===
                                                input.recipe_criteria_id}},[_vm._v("\n                                              "+_vm._s(nutrient.name)+"\n                                            ")])})],2),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2 py-auto my-auto text-center align-bottom"},[_c('button',{staticClass:"btn btn-lg btn-primary text-white rounded-circle align-bottom text-center",attrs:{"role":"button"},on:{"click":function($event){$event.preventDefault();return _vm.cloneProperty2($event)}}},[_c('i',{staticClass:"fa fa-plus"})]),_vm._v(" "),(
                                          _vm.data.recipes_criteria_values
                                            .length > 1
...
// CONCATENATED MODULE: ./pages/panel/recipes/update/_id.vue?vue&type=template&id=1bb81bc3&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/recipes/update/_id.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      counter2: this.data !== null && this.data !== undefined && this.data !== "" && this.data.recipes_criteria_values !== null && this.data.recipes_criteria_values !== undefined && this.data.recipes_criteria_values !== "" ? this.data.recipes_criteria_values.length : 0,
      e1: 1,
      imageData: [],
      data: {
        images: []
      ...
      loading: false,
      options: {
        url: "https://api.klinikdiyetisyen.com/api/" + "panel/recipes/create-file/" + this.$route.params.id,
        headers: {
  ...
  async asyncData({
    ...
    try {
      const {
        data
      } = await $axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/recipes/update/" + params.id);
      console.log(data);
      ...
      if (data.data.recipes_criteria_values.length === 0 || data.data.recipes_criteria_values.length === null || data.data.recipes_criteria_values.length === undefined) {
      ...
      error({
        message: "Yemek Tarifi Bilgisi Bulunamadı.",
        statusCode: 404
      });
    }
  },
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/datatables/${urlParam}?table=recipes_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=recipes_id&where_value=${this.data._id.$oid}&joins=recipes_file`, {
        json: true,
    ...
    deleteData(id) {
      this.$axios.delete("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/delete-file?id=" + id + "&table=recipes_file", {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/is-active-setter?table=recipes_file&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isCoverSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/is-cover-setter?table=recipes_file&foreign_column=recipes_id&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    editRecipes() {
      ...
      this.$axios.post("https://api.klinikdiyetisyen.com/api/" + "panel/recipes/update/" + this.data._id.$oid, formData, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
...
// CONCATENATED MODULE: ./pages/panel/recipes/update/_id.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/panel/recipes/update/_id.vue
