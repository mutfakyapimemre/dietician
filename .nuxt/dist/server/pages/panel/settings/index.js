...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/settings/index.vue?vue&type=template&id=1ab79a9e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',[_c('div',{staticClass:"main-wrapper"},[_c('div',{staticClass:"page-wrapper"},[_c('div',{staticClass:"content container-fluid"},[_c('div',{staticClass:"page-header"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12"},[_c('h3',{staticClass:"page-title"},[_vm._v("Ayarlar")]),_vm._v(" "),_c('ul',{staticClass:"breadcrumb"},[_c('li',{staticClass:"breadcrumb-item"},[_c('nuxt-link',{attrs:{"to":"/panel","tag":"a"}},[_vm._v("Anasayfa")])],1),_vm._v(" "),_c('li',{staticClass:"breadcrumb-item active"},[_vm._v("Ayarlar")])])])])]),_vm._v(" "),_c('v-card',{attrs:{"tile":""}},[_c('v-card-title',{staticClass:"d-flex justify-content-between"},[_c('span',{staticClass:"justify-content-center flex-grow-1"},[_c('v-text-field',{staticClass:"my-auto py-auto",attrs:{"label":"Arama Yapın..."},on:{"keyup":function($event){$event.preventDefault();_vm.page = 1;
                  _vm.retrieveData('get-by-search');}},model:{value:(_vm.searchTitle),callback:function ($$v) {_vm.searchTitle=$$v},expression:"searchTitle"}})],1),_vm._v(" "),_c('span',{staticClass:"justify-content-end flex-shrink-1"},[_c('nuxt-link',{staticClass:"float-right btn btn-info-light ml-3 my-auto py-auto",attrs:{"to":"/panel/settings/add","tag":"a"}},[_c('i',{staticClass:"fa fa-plus"}),_vm._v(" Ekle\n              ")])],1)]),_vm._v(" "),_c('v-data-table',{attrs:{"headers":_vm.headers,"items":_vm.data,"disable-pagination":"","hide-default-footer":true},scopedSlots:_vm._u([{key:"item.logo",fn:function(ref){
                  var item = ref.item;
return [_c('img',{attrs:{"src":item.logo,"width":"220","height":"60"}})]}},{key:"item.isActive",fn:function(ref){
                  var item = ref.item;
return [_c('v-layout',{attrs:{"justify-center":""}},[_c('v-switch',{key:item.id,staticClass:"d-flex justify-content-center mx-auto px-auto text-center",attrs:{"color":"success"},on:{"click":function($event){return _vm.isActiveSetter(item.id)}},model:{value:(item.isActive),callback:function ($$v) {_vm.$set(item, "isActive", $$v)},expression:"item.isActive"}})],1)]}},{key:"item.actions",fn:function(ref){
                  var item = ref.item;
return [_c('v-icon',{staticClass:"mr-2",attrs:{"small":""},on:{"click":function($event){return _vm.editData(item.id)}}},[_vm._v("\n                mdi-pencil\n              ")]),_vm._v(" "),_c('v-icon',{attrs:{"small":""},on:{"click":function($event){return _vm.deleteData(item.id)}}},[_vm._v(" mdi-delete ")])]}}],null,true)})],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"cols":"12","xs":"12","sm":"12","md":"3","lg":"3","xl":"3"}},[_c('v-select',{attrs:{"items":_vm.pageSizes,"label":"Sayfada Görüntüleme Sayısı"},on:{"change":_vm.handlePageSizeChange},model:{value:(_vm.pageSize),callback:function ($$v) {_vm.pageSize=$$v},expression:"pageSize"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","xs":"12","sm":"12","md":"9","lg":"9","xl":"9"}},[_c('v-pagination',{attrs:{"length":_vm.totalPages,"total-visible":"7","next-icon":"mdi-menu-right","prev-icon":"mdi-menu-left"},on:{"input":_vm.handlePageChange},model:{value:(_vm.page),callback:function ($$v) {_vm.page=$$v},expression:"page"}})],1)],1)],1)])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/panel/settings/index.vue?vue&type=template&id=1ab79a9e&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/settings/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var settingsvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/datatables/${urlParam}?table=settings&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=company_name`, {
        json: true,
    ...
    deleteData(id) {
      this.$axios.delete("https://api.klinikdiyetisyen.com/api/" + "panel/settings/delete/" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/is-active-setter?table=settings&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
...
// CONCATENATED MODULE: ./pages/panel/settings/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var panel_settingsvue_type_script_lang_js_ = (settingsvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/panel/settings/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  panel_settingsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
