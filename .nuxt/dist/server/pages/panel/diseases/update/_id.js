...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/diseases/update/_id.vue?vue&type=template&id=625247ae&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',[_c('div',{staticClass:"main-wrapper"},[_c('div',{staticClass:"page-wrapper"},[_c('div',{staticClass:"content container-fluid"},[_c('div',{staticClass:"page-header"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12"},[_c('h3',{staticClass:"page-title"},[_vm._v("Hastalık Düzenle")]),_vm._v(" "),_c('ul',{staticClass:"breadcrumb"},[_c('li',{staticClass:"breadcrumb-item"},[_c('nuxt-link',{attrs:{"to":"/panel","tag":"a"}},[_vm._v("Anasayfa")])],1),_vm._v(" "),_c('li',{staticClass:"breadcrumb-item active"},[_vm._v("Hastalık Düzenle")])])])])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-12"},[_c('div',{staticClass:"card"},[_c('div',{staticClass:"card-header"},[_c('h4',{staticClass:"card-title"},[_vm._v("Hastalık Düzenle")])]),_vm._v(" "),_c('div',{staticClass:"card-body"},[_c('ValidationObserver',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
var handleSubmit = ref.handleSubmit;
return [_c('form',{ref:"diseasesForm",attrs:{"enctype":"multipart/form-data"},on:{"submit":function($event){$event.preventDefault();return handleSubmit(_vm.editDiseases)}}},[_c('v-stepper',{model:{value:(_vm.e1),callback:function ($$v) {_vm.e1=$$v},expression:"e1"}},[_c('v-stepper-header',[_c('v-stepper-step',{attrs:{"complete":_vm.e1 > 1,"step":"1"}},[_vm._v("\n                          Hastalık Bilgileri\n                        ")]),_vm._v(" "),_c('v-divider')],1),_vm._v(" "),_c('v-stepper-items',[_c('v-stepper-content',{attrs:{"step":"1"}},[_c('ValidationProvider',{attrs:{"name":"Hastalık Adı","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"title"}},[_vm._v("Hastalık Adı")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.data.name),expression:"data.name"}],staticClass:"form-control",attrs:{"id":"title","type":"text","name":"name"},domProps:{"value":(_vm.data.name)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.data, "name", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Hastalık Açıklaması","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"description"}},[_vm._v("Hastalık Açıklaması")]),_vm._v(" "),_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(_vm.data.description),expression:"data.description"}],staticClass:"form-control",attrs:{"id":"description","name":"description"},domProps:{"value":(_vm.data.description)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.data, "description", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('v-tabs',{attrs:{"background-color":"primary","dark":""},model:{value:(_vm.tab),callback:function ($$v) {_vm.tab=$$v},expression:"tab"}},_vm._l((_vm.items),function(item){return _c('v-tab',{key:item.tab},[_vm._v("\n                              "+_vm._s(item.tab)+"\n                            ")])}),1),_vm._v(" "),_c('v-tabs-items',{model:{value:(_vm.tab),callback:function ($$v) {_vm.tab=$$v},expression:"tab"}},[_c('v-tab-item',{attrs:{"eager":""}},[_c('v-card',{attrs:{"flat":""}},[(
                                    _vm.data.values !== null &&
                                    _vm.data.values !== undefined &&
                                    _vm.data.values !== '' &&
                                    _vm.data.values.length > 0
                                  )?_c('v-card-text',_vm._l((_vm.data.values),function(input,index){return _c('div',{key:index,staticClass:"row"},[_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4"},[_c('ValidationProvider',{attrs:{"name":"Hastalık Değeri Adı","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":'disease' + index}},[_vm._v("Hastalık Değeri Adı")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input.title),expression:"input.title"}],staticClass:"form-control",attrs:{"id":'disease' + index,"type":"text","name":"diseaseName[]"},domProps:{"value":(input.title)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input, "title", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2"},[_c('ValidationProvider',{attrs:{"name":"Minimum Hastalık Değeri","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":'diseaseMin' + index}},[_vm._v("Minimum Hastalık Değeri")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input.min),expression:"input.min"}],staticClass:"form-control",attrs:{"id":'diseaseMin' + index,"type":"text","name":"diseaseMin[]"},domProps:{"value":(input.min)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input, "min", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2"},[_c('ValidationProvider',{attrs:{"name":"Maximum Hastalık Değeri","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":'diseaseMax' + index}},[_vm._v("Maximum Hastalık Değeri")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input.max),expression:"input.max"}],staticClass:"form-control",attrs:{"id":'diseaseMax' + index,"type":"text","name":"diseaseMax[]"},domProps:{"value":(input.max)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input, "max", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2"},[_c('ValidationProvider',{attrs:{"name":"Hastalık Değeri Türü","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":'diseaseType' + index}},[_vm._v("Hastalık Değeri Türü")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input.type),expression:"input.type"}],staticClass:"form-control",attrs:{"id":'diseaseType' + index,"type":"text","name":"diseaseType[]"},domProps:{"value":(input.type)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input, "type", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2 py-auto my-auto text-center align-bottom"},[_c('button',{staticClass:"btn btn-lg btn-primary text-white rounded-circle align-bottom text-center",attrs:{"role":"button"},on:{"click":function($event){$event.preventDefault();return _vm.cloneProperty($event)}}},[_c('i',{staticClass:"fa fa-plus"})]),_vm._v(" "),(_vm.data.values.length > 1)?_c('button',{staticClass:"btn btn-lg btn-danger text-white rounded-circle align-bottom text-center",attrs:{"role":"button"},on:{"click":function($event){$event.preventDefault();return _vm.removeProperty(index)}}},[_c('i',{staticClass:"fa fa-times"})]):_vm._e()])])}),0):_vm._e()],1)],1)],1),_vm._v(" "),_c('button',{staticClass:"btn btn-outline-primary rounded-0 btn-lg",attrs:{"type":"submit"}},[_vm._v("\n                            Hastalığı Güncelle\n                          ")])],1)],1)],1)],1)]}}])})],1)])])])])])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/panel/diseases/update/_id.vue?vue&type=template&id=625247ae&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/diseases/update/_id.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      loading: false,
      options: {
        url: "https://api.klinikdiyetisyen.com/api/" + "panel/diseases/create-file/" + this.$route.params.id,
        headers: {
  ...
  async asyncData({
    ...
    try {
      const {
        data
      } = await $axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/diseases/update/" + params.id);
      ...
      error({
        message: "Hastalık Bilgisi Bulunamadı.",
        statusCode: 404
      });
    }
  },
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/datatables/${urlParam}?table=diseases_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=diseases_id&where_value=${this.data._id.$oid}&joins=diseases_file`, {
        json: true,
    ...
    deleteData(id) {
      this.$axios.delete("https://api.klinikdiyetisyen.com/api/" + "panel/diseases/delete/" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/is-active-setter?table=diseases_file&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isCoverSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/is-cover-setter?table=diseases_file&foreign_column=diseases_id&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    editDiseases() {
      ...
      this.$axios.post("https://api.klinikdiyetisyen.com/api/" + "panel/diseases/update/" + this.data._id.$oid, formData, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
...
// CONCATENATED MODULE: ./pages/panel/diseases/update/_id.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/panel/diseases/update/_id.vue
...
installComponents_default()(component, {VApp: VApp["a" /* default */],VCard: VCard["a" /* default */],VCardText: components_VCard["c" /* VCardText */],VDivider: VDivider["a" /* default */],VStepper: VStepper["a" /* default */],VStepperContent: VStepperContent["a" /* default */],VStepperHeader: components_VStepper["a" /* VStepperHeader */],VStepperItems: components_VStepper["b" /* VStepperItems */],VStepperStep: VStepperStep["a" /* default */],VTab: VTab["a" /* default */],VTabItem: VTabItem["a" /* default */],VTabs: VTabs["a" /* default */],VTabsItems: VTabsItems["a" /* default */]})
