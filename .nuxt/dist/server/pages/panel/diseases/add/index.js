...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/diseases/add/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var addvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      loading: false,
      options: {
        url: "https://api.klinikdiyetisyen.com/api/" + "panel/diseases/create-file/",
        headers: {
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/datatables/${urlParam}?table=diseases_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=nutrients_id&where_value=${this.inputData.id}&joins=diseases_file`, {
        json: true,
    ...
    saveDiseases() {
      ...
      this.$axios.post("https://api.klinikdiyetisyen.com/api/" + "panel/diseases/create", formData, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
...
// CONCATENATED MODULE: ./pages/panel/diseases/add/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var diseases_addvue_type_script_lang_js_ = (addvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/panel/diseases/add/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  diseases_addvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
