...
// CONCATENATED MODULE: ./pages/panel/exercise-categories/add/index.vue?vue&type=template&id=0bd88619&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/exercise-categories/add/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var addvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      loading: false,
      options: {
        url: "https://api.klinikdiyetisyen.com/api/" + "panel/exercise-categories/create-file/",
        headers: {
  ...
  methods: {
    saveExerciseCategories() {
      ...
      this.$axios.post("https://api.klinikdiyetisyen.com/api/" + "panel/exercise-categories/create", formData, {
        json: true,
        ...
        if (response.data.success) {
          ...
          this.$refs.myDropzone.options.url = "https://api.klinikdiyetisyen.com/api/" + "panel/exercise-categories/create-file/" + response.data.data.$oid;
          this.$refs.myDropzone.dropzone.options.url = "https://api.klinikdiyetisyen.com/api/" + "panel/exercise-categories/create-file/" + response.data.data.$oid;
          this.options.url = "https://api.klinikdiyetisyen.com/api/" + "panel/exercise-categories/create-file/" + response.data.data.$oid;
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/datatables/${urlParam}?table=exercise_categories_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=exercise_category_id&where_value=${this.inputData.id}&joins=exercise_categories_file`, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    deleteData(id) {
      this.$axios.delete("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/delete-file?id=" + id + "&table=exercise_categories_file", {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/is-active-setter?table=exercise_categories_file&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isCoverSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/is-cover-setter?table=exercise_categories_file&foreign_column=exercise_category_id&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
...
// CONCATENATED MODULE: ./pages/panel/exercise-categories/add/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var exercise_categories_addvue_type_script_lang_js_ = (addvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/panel/exercise-categories/add/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  exercise_categories_addvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
