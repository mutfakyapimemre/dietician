...
// CONCATENATED MODULE: ./pages/panel/exercise-categories/update/_id.vue?vue&type=template&id=dd1b142a&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/exercise-categories/update/_id.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      loading: false,
      options: {
        url: "https://api.klinikdiyetisyen.com/api/" + "panel/exercise-categories/create-file/" + this.$route.params.id,
        headers: {
  ...
  async asyncData({
    ...
    try {
      const {
        data
      } = await $axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/exercise-categories/update/" + params.id);
      return data;
    } catch (e) {
      error({
        message: "Egzersiz Kategorisi Bulunamadı.",
        statusCode: 404
      });
    }
  },
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/datatables/${urlParam}?table=exercise_categories_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=exercise_category_id&where_value=${this.data._id.$oid}&joins=exercise_categories_file`, {
        json: true,
    ...
    editExerciseCategories() {
      ...
      this.$axios.post("https://api.klinikdiyetisyen.com/api/" + "panel/exercise-categories/update/" + this.data._id.$oid, formData, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
...
// CONCATENATED MODULE: ./pages/panel/exercise-categories/update/_id.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/panel/exercise-categories/update/_id.vue
