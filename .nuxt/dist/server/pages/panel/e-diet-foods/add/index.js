...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/e-diet-foods/add/index.vue?vue&type=template&id=2f44787a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',[_c('div',{staticClass:"main-wrapper"},[_c('div',{staticClass:"page-wrapper"},[_c('div',{staticClass:"content container-fluid"},[_c('div',{staticClass:"page-header"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12"},[_c('h3',{staticClass:"page-title"},[_vm._v("E-Diyet Besinleri")]),_vm._v(" "),_c('ul',{staticClass:"breadcrumb"},[_c('li',{staticClass:"breadcrumb-item"},[_c('nuxt-link',{attrs:{"to":"/panel","tag":"a"}},[_vm._v("Anasayfa")])],1),_vm._v(" "),_c('li',{staticClass:"breadcrumb-item active"},[_vm._v("E-Diyet Besinleri")])])])])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-12"},[_c('div',{staticClass:"card"},[_c('div',{staticClass:"card-header"},[_c('h4',{staticClass:"card-title"},[_vm._v("Besin Ekle")])]),_vm._v(" "),_c('div',{staticClass:"card-body"},[_c('ValidationObserver',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
var handleSubmit = ref.handleSubmit;
return [_c('form',{ref:"eDietFoodsForm",attrs:{"enctype":"multipart/form-data"},on:{"submit":function($event){$event.preventDefault();return handleSubmit(_vm.saveEdietFoods)}}},[_c('v-stepper',{model:{value:(_vm.e1),callback:function ($$v) {_vm.e1=$$v},expression:"e1"}},[_c('v-stepper-header',[_c('v-stepper-step',{attrs:{"complete":_vm.e1 > 1,"step":"1"}},[_vm._v("\n                          Besin Bilgileri\n                        ")]),_vm._v(" "),_c('v-divider'),_vm._v(" "),_c('v-stepper-step',{attrs:{"complete":_vm.e1 > 2,"step":"2"}},[_vm._v("\n                          Besin Görselleri\n                        ")]),_vm._v(" "),_c('v-divider'),_vm._v(" "),_c('v-stepper-step',{attrs:{"complete":_vm.e1 > 3,"step":"3"}},[_vm._v("\n                          Kapak Fotoğrafı Seçimi\n                        ")])],1),_vm._v(" "),_c('v-stepper-items',[_c('v-stepper-content',{attrs:{"step":"1"}},[_c('ValidationProvider',{attrs:{"name":"Besin Adı","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"title"}},[_vm._v("Besin Adı")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.inputData.name),expression:"inputData.name"}],staticClass:"form-control",attrs:{"id":"title","type":"text","name":"name"},domProps:{"value":(_vm.inputData.name)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.inputData, "name", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Besin Açıklaması","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"description"}},[_vm._v("Besin Açıklaması")]),_vm._v(" "),_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(_vm.inputData.description),expression:"inputData.description"}],staticClass:"form-control",attrs:{"id":"description","name":"description"},domProps:{"value":(_vm.inputData.description)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.inputData, "description", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Miktar","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":"quantity"}},[_vm._v("Miktar")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.inputData.quantity),expression:"inputData.quantity"}],staticClass:"form-control",attrs:{"id":"quantity","type":"text","name":"quantity"},domProps:{"value":(_vm.inputData.quantity)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.inputData, "quantity", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Öğün","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('v-select',{attrs:{"name":"meals[]","items":_vm.meals,"label":"Öğün Seçin","item-text":"name","item-value":"_id.$oid","multiple":""},scopedSlots:_vm._u([{key:"prepend-item",fn:function(){return [_c('v-list-item',{attrs:{"ripple":""},on:{"click":_vm.toggle}},[_c('v-list-item-action',[_c('v-icon',{attrs:{"color":(_vm.selectedMeals !== undefined && _vm.selectedMeals !== null && _vm.selectedMeals !== '' && _vm.selectedMeals.length > 0)  ? 'indigo darken-4' : ''}},[_vm._v("\n                                        "+_vm._s(_vm.icon)+"\n                                      ")])],1),_vm._v(" "),_c('v-list-item-content',[_c('v-list-item-title',[_vm._v("\n                                        Tümünü Seç\n                                      ")])],1)],1),_vm._v(" "),_c('v-divider',{staticClass:"mt-2"})]},proxy:true},{key:"item",fn:function(data){return [[_c('v-list-item-content',[_c('v-list-item-title',{domProps:{"innerHTML":_vm._s(data.item.name)}})],1)]]}}],null,true),model:{value:(_vm.selectedMeals),callback:function ($$v) {_vm.selectedMeals=$$v},expression:"selectedMeals"}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])],1)]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Yaş Grubu","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('v-select',{attrs:{"name":"ageGroups","items":_vm.ageGroups,"label":"Yaş Grubu Seçin"},model:{value:(_vm.selectedAgeGroups),callback:function ($$v) {_vm.selectedAgeGroups=$$v},expression:"selectedAgeGroups"}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])],1)]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{attrs:{"name":"Hastalık","rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('v-autocomplete',{attrs:{"name":"selectedDiseases[]","items":_vm.diseases,"chips":"","label":"Hastalık Seçin","item-text":"name","item-value":"_id.$oid","multiple":""},scopedSlots:_vm._u([{key:"prepend-item",fn:function(){return [_c('v-list-item',{attrs:{"ripple":""},on:{"click":_vm.toggle3}},[_c('v-list-item-action',[_c('v-icon',{attrs:{"color":(_vm.selectedDiseases !== undefined && _vm.selectedDiseases !== null && _vm.selectedDiseases !== '' && _vm.selectedDiseases.length > 0) ? 'indigo darken-4' : ''}},[_vm._v("\n                                        "+_vm._s(_vm.icon3)+"\n                                      ")])],1),_vm._v(" "),_c('v-list-item-content',[_c('v-list-item-title',[_vm._v("\n                                        Tümünü Seç\n                                      ")])],1)],1),_vm._v(" "),_c('v-divider',{staticClass:"mt-2"})]},proxy:true},{key:"selection",fn:function(data){return [_c('v-chip',_vm._b({attrs:{"input-value":data.selected,"close":""},on:{"click":data.select,"click:close":function($event){return _vm.remove(data.item)}}},'v-chip',data.attrs,false),[_vm._v("\n                                      "+_vm._s(data.item.name)+"\n                                    ")])]}},{key:"item",fn:function(data){return [[_c('v-list-item-content',[_c('v-list-item-title',{domProps:{"innerHTML":_vm._s(data.item.name)}})],1)]]}}],null,true),model:{value:(_vm.selectedDiseases),callback:function ($$v) {_vm.selectedDiseases=$$v},expression:"selectedDiseases"}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])],1)]}}],null,true)}),_vm._v(" "),_c('v-tabs',{attrs:{"background-color":"primary","dark":""},model:{value:(_vm.tab),callback:function ($$v) {_vm.tab=$$v},expression:"tab"}},_vm._l((_vm.items),function(item){return _c('v-tab',{key:item.tab},[_vm._v("\n                              "+_vm._s(item.tab)+"\n                            ")])}),1),_vm._v(" "),_c('v-tabs-items',{model:{value:(_vm.tab),callback:function ($$v) {_vm.tab=$$v},expression:"tab"}},[_c('v-tab-item',{attrs:{"eager":""}},[_c('v-card',{attrs:{"flat":""}},[(
                                    _vm.inputs !== null &&
                                    _vm.inputs !== undefined &&
                                    _vm.inputs !== ''
                                  )?_c('v-card-text',_vm._l((_vm.inputs),function(input,index){return _c('div',{key:index,staticClass:"row"},[_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4"},[_c('ValidationProvider',{attrs:{"name":input[0].label,"rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":input[0].id}},[_vm._v(_vm._s(input[0].label))]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input[0].value),expression:"input[0].value"}],staticClass:"form-control",attrs:{"id":input[0].id,"type":"text","name":"vitaminName[]"},domProps:{"value":(input[0].value)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input[0], "value", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3"},[_c('ValidationProvider',{attrs:{"name":input[1].label,"rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":input[1].id}},[_vm._v(_vm._s(input[1].label))]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input[1].value),expression:"input[1].value"}],staticClass:"form-control",attrs:{"id":input[1].id,"type":"text","name":"vitaminValue[]"},domProps:{"value":(input[1].value)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input[1], "value", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3"},[_c('ValidationProvider',{attrs:{"name":input[2].label,"rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":input[2].id}},[_vm._v(_vm._s(input[2].label))]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input[2].value),expression:"input[2].value"}],staticClass:"form-control",attrs:{"id":input[2].id,"type":"text","name":"vitaminType[]"},domProps:{"value":(input[2].value)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input[2], "value", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2 py-auto my-auto text-center align-bottom"},[_c('button',{staticClass:"btn btn-lg btn-primary text-white rounded-circle align-bottom text-center",attrs:{"role":"button"},on:{"click":function($event){$event.preventDefault();return _vm.cloneProperty($event)}}},[_c('i',{staticClass:"fa fa-plus"})]),_vm._v(" "),(_vm.inputs.length > 1)?_c('button',{staticClass:"btn btn-lg btn-danger text-white rounded-circle align-bottom text-center",attrs:{"role":"button"},on:{"click":function($event){$event.preventDefault();return _vm.removeProperty(input[0].id)}}},[_c('i',{staticClass:"fa fa-times"})]):_vm._e()])])}),0):_vm._e()],1)],1),_vm._v(" "),_c('v-tab-item',{attrs:{"eager":""}},[_c('v-card',{attrs:{"flat":""}},[(
                                    _vm.inputs2 !== null &&
                                    _vm.inputs2 !== undefined &&
                                    _vm.inputs2 !== '' &&
                                    _vm.allCriterias !== null &&
                                    _vm.allCriterias !== undefined &&
                                    _vm.allCriterias !== ''
                                  )?_c('v-card-text',_vm._l((_vm.inputs2),function(input2,index){return _c('div',{key:index,staticClass:"row"},[_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4"},[_c('ValidationProvider',{attrs:{"name":input2[0].label,"rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                  var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":input2[0].id}},[_vm._v(_vm._s(input2[0].label))]),_vm._v(" "),(
                                              _vm.allCriterias !== null &&
                                              _vm.allCriterias !== undefined &&
                                              _vm.allCriterias !== '' &&
                                              _vm.allCriterias.length > 0
                                            )?_c('select',{directives:[{name:"model",rawName:"v-model",value:(input2[0].value),expression:"input2[0].value"}],staticClass:"form-control",attrs:{"name":"criteriaName[]","id":input2[0].id},on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.$set(input2[0], "value", $event.target.multiple ? $$selectedVal : $$selectedVal[0])}}},[_c('option',{attrs:{"selected":""},domProps:{"value":null}},[_vm._v("\n                                              Ölçüt Seçiniz.\n                                            ")]),_vm._v(" "),_vm._l((_vm.allCriterias),function(criteria,index){return _c('option',{key:index,domProps:{"value":criteria.name}},[_vm._v("\n                                              "+_vm._s(criteria.name)+"\n                                            ")])})],2):(
                                              _vm.allCriterias === null &&
                                              _vm.allCriterias === undefined &&
                                              _vm.allCriterias === '' &&
                                              _vm.allCriterias.length <= 0
                                            )?_c('select',{directives:[{name:"model",rawName:"v-model",value:(input2[0].value),expression:"input2[0].value"}],staticClass:"form-control",attrs:{"name":"criteriaName[]","id":input2[0].id},on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.$set(input2[0], "value", $event.target.multiple ? $$selectedVal : $$selectedVal[0])}}},[_c('option',{attrs:{"selected":""},domProps:{"value":null}},[_vm._v("\n                                              Ölçüt Seçiniz.\n                                            ")])]):_vm._e(),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3"},[_c('ValidationProvider',{attrs:{"name":input2[1].label,"rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                            var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":input2[1].id}},[_vm._v(_vm._s(input2[1].label))]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input2[1].value),expression:"input2[1].value"}],staticClass:"form-control",attrs:{"id":input2[1].id,"type":"text","name":"criteriaValue[]"},domProps:{"value":(input2[1].value)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input2[1], "value", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3"},[_c('ValidationProvider',{attrs:{"name":input2[2].label,"rules":"required"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
                                            var errors = ref.errors;
return [_c('div',{staticClass:"form-group"},[_c('label',{attrs:{"for":input2[2].id}},[_vm._v(_vm._s(input2[2].label))]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(input2[2].value),expression:"input2[2].value"}],staticClass:"form-control",attrs:{"id":input2[2].id,"type":"text","name":"criteriaType[]"},domProps:{"value":(input2[2].value)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(input2[2], "value", $event.target.value)}}}),_vm._v(" "),_c('small',{staticClass:"font-weight-bold text-danger"},[_vm._v(_vm._s(errors[0]))])])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2 py-auto my-auto text-center align-bottom"},[_c('button',{staticClass:"btn btn-lg btn-primary text-white rounded-circle align-bottom text-center",attrs:{"role":"button"},on:{"click":function($event){$event.preventDefault();return _vm.cloneProperty2($event)}}},[_c('i',{staticClass:"fa fa-plus"})]),_vm._v(" "),(_vm.inputs2.length > 1)?_c('button',{staticClass:"btn btn-lg btn-danger text-white rounded-circle align-bottom text-center",attrs:{"role":"button"},on:{"click":function($event){$event.preventDefault();return _vm.removeProperty2(input2[0].id)}}},[_c('i',{staticClass:"fa fa-times"})]):_vm._e()])])}),0):_vm._e()],1)],1)],1),_vm._v(" "),_c('button',{staticClass:"btn btn-outline-primary rounded-0 btn-lg",attrs:{"type":"submit"}},[_vm._v("\n                            Besini Kayıt Et, Görsel Yüklemeye Geç\n                          ")])],1),_vm._v(" "),_c('v-stepper-content',{attrs:{"step":"2"}},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"},[_c('dropzone',{ref:"myDropzone",attrs:{"id":"dropzone","options":_vm.options,"headers":_vm.options.headers},on:{"vdropzone-complete":_vm.onComplete}})],1)]),_vm._v(" "),_c('button',{staticClass:"btn btn-outline-primary rounded-0 btn-lg",attrs:{"role":"button"},on:{"click":function($event){$event.preventDefault();return _vm.selectCover($event)}}},[_vm._v("\n                            Kapak Fotoğrafı Seç\n                          ")])]),_vm._v(" "),_c('v-stepper-content',{attrs:{"step":"3"}},[_c('div',{staticClass:"card"},[_c('div',{staticClass:"card-header"},[_c('h4',{staticClass:"card-title"},[_vm._v("Görseller")])]),_vm._v(" "),_c('div',{staticClass:"card-body"},[_c('v-card',{attrs:{"tile":""}},[_c('v-data-table',{attrs:{"headers":_vm.headers,"items":_vm.data,"disable-pagination":"","hide-default-footer":true},scopedSlots:_vm._u([{key:"item.img_url",fn:function(ref){
                                            var item = ref.item;
...
// CONCATENATED MODULE: ./pages/panel/e-diet-foods/add/index.vue?vue&type=template&id=2f44787a&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/panel/e-diet-foods/add/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var addvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      loading: false,
      options: {
        url: "https://api.klinikdiyetisyen.com/api/" + "panel/e-diet-foods/create-file/",
        headers: {
  ...
  methods: {
    ...
    getCriterias() {
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/e-diet-foods/create`, {
        json: true,
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/datatables/${urlParam}?table=edietfoods_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=edietfoods_id&where_value=${this.inputData.id}&joins=edietfoods_file`, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    saveEdietFoods() {
      ...
      this.$axios.post("https://api.klinikdiyetisyen.com/api/" + "panel/e-diet-foods/create", formData, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
        ...
        if (response.data.success) {
          ...
          this.$refs.myDropzone.options.url = "https://api.klinikdiyetisyen.com/api/" + "panel/e-diet-foods/create-file/" + response.data.data.$oid;
          this.$refs.myDropzone.dropzone.options.url = "https://api.klinikdiyetisyen.com/api/" + "panel/e-diet-foods/create-file/" + response.data.data.$oid;
          this.options.url = "https://api.klinikdiyetisyen.com/api/" + "panel/e-diet-foods/create-file/" + response.data.data.$oid;
...
// CONCATENATED MODULE: ./pages/panel/e-diet-foods/add/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var e_diet_foods_addvue_type_script_lang_js_ = (addvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/panel/e-diet-foods/add/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  e_diet_foods_addvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
