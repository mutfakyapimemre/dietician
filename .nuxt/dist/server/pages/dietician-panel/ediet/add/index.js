...
// CONCATENATED MODULE: ./pages/dietician-panel/ediet/add/index.vue?vue&type=template&id=0cdf08d0&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dietician-panel/ediet/add/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var addvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      loading: false,
      options: {
        url: "https://api.klinikdiyetisyen.com/api/" + "panel/nutrients/create-file/",
        headers: {
  ...
  methods: {
    getCriterias() {
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/nutrients/create`, {
        json: true,
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}panel/datatables/${urlParam}?table=nutrients_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=nutrients_id&where_value=${this.inputData.id}&joins=nutrients_file`, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    deleteData(id) {
      this.$axios.delete("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/delete-file?id=" + id + "&table=nutrients_file", {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/is-active-setter?table=nutrients_file&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isCoverSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "panel/datatables/is-cover-setter?table=nutrients_file&foreign_column=nutrients_id&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    saveNutrients() {
      ...
      this.$axios.post("https://api.klinikdiyetisyen.com/api/" + "panel/nutrients/create", formData, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
        ...
        if (response.data.success) {
          ...
          this.$refs.myDropzone.options.url = "https://api.klinikdiyetisyen.com/api/" + "panel/nutrients/create-file/" + response.data.data.$oid;
          this.$refs.myDropzone.dropzone.options.url = "https://api.klinikdiyetisyen.com/api/" + "panel/nutrients/create-file/" + response.data.data.$oid;
          this.options.url = "https://api.klinikdiyetisyen.com/api/" + "panel/nutrients/create-file/" + response.data.data.$oid;
...
// CONCATENATED MODULE: ./pages/dietician-panel/ediet/add/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var ediet_addvue_type_script_lang_js_ = (addvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/dietician-panel/ediet/add/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  ediet_addvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
