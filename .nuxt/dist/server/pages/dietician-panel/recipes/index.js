...
return [_c('v-layout',{attrs:{"justify-center":""}},[_c('v-switch',{key:item.id,staticClass:"d-flex justify-content-center mx-auto px-auto text-center",attrs:{"color":"success"},on:{"click":function($event){return _vm.isActiveSetter(item.id)}},model:{value:(item.isActive),callback:function ($$v) {_vm.$set(item, "isActive", $$v)},expression:"item.isActive"}})],1)]}},{key:"item.actions",fn:function(ref){
                          var item = ref.item;
return [_c('v-icon',{staticClass:"mr-2",attrs:{"small":""},on:{"click":function($event){return _vm.editData(item.id)}}},[_vm._v("\n                        mdi-pencil\n                      ")]),_vm._v(" "),_c('v-icon',{attrs:{"small":""},on:{"click":function($event){return _vm.deleteData(item.id)}}},[_vm._v("\n                        mdi-delete\n                      ")])]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"row"},[_c('v-col',{attrs:{"cols":"12","sm":"12"}},[_c('div',{staticClass:"row"},[_c('v-col',{attrs:{"cols":"12","lg":"3"}},[_c('v-select',{attrs:{"items":_vm.pageSizes,"label":"Sayfada Görüntüleme Sayısı"},on:{"change":_vm.handlePageSizeChange},model:{value:(_vm.pageSize),callback:function ($$v) {_vm.pageSize=$$v},expression:"pageSize"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","lg":"9"}},[_c('v-pagination',{attrs:{"length":_vm.totalPages,"total-visible":"7","next-icon":"mdi-menu-right","prev-icon":"mdi-menu-left"},on:{"input":_vm.handlePageChange},model:{value:(_vm.page),callback:function ($$v) {_vm.page=$$v},expression:"page"}})],1)],1)])],1)],1)])])])])])])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/dietician-panel/recipes/index.vue?vue&type=template&id=00e26687&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dietician-panel/recipes/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var recipesvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}dietician/recipes/${urlParam}?table=recipes&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name&where_column=dietician_id&where_value=${this.userData._id}`, {
        json: true,
    ...
    isActiveSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "dietician/datatables/is-active-setter?table=recipes&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
...
// CONCATENATED MODULE: ./pages/dietician-panel/recipes/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var dietician_panel_recipesvue_type_script_lang_js_ = (recipesvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/dietician-panel/recipes/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  dietician_panel_recipesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
