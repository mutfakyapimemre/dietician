...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dietician-panel/recipes/add/index.vue?vue&type=template&id=4e447d6a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',[_c('div',{staticClass:"main-wrapper"},[_c('div',{staticClass:"page-wrapper"},[_c('div',{staticClass:"content container-fluid"},[_c('div',{staticClass:"page-header"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12"},[_c('h3',{staticClass:"page-title"},[_vm._v("Yemek Tarifleri")]),_vm._v(" "),_c('ul',{staticClass:"breadcrumb"},[_c('li',{staticClass:"breadcrumb-item"},[_c('nuxt-link',{attrs:{"to":"/dietician-panel","tag":"a"}},[_vm._v("Anasayfa")])],1),_vm._v(" "),_c('li',{staticClass:"breadcrumb-item active"},[_vm._v("Yemek Tarifleri")])])])])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-12"},[_c('div',{staticClass:"card"},[_c('div',{staticClass:"card-header"},[_c('h4',{staticClass:"card-title"},[_vm._v("Yemek Tarifi Ekle")])]),_vm._v(" "),_c('div',{staticClass:"card-body"},[_c('ValidationObserver',{scopedSlots:_vm._u([{key:"default",fn:function(ref){
...
// CONCATENATED MODULE: ./pages/dietician-panel/recipes/add/index.vue?vue&type=template&id=4e447d6a&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dietician-panel/recipes/add/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var addvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      loading: false,
      options: {
        url: "https://api.klinikdiyetisyen.com/api/" + "dietician/recipes/create-file/",
        headers: {
  ...
  methods: {
    getCriterias() {
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}dietician/recipes/create`, {
        json: true,
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}dietician/datatables/${urlParam}?table=recipes_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=recipes_id&where_value=${this.inputData.id}&joins=recipes_file`, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    deleteData(id) {
      this.$axios.delete("https://api.klinikdiyetisyen.com/api/" + "dietician/recipes/delete-file?id=" + id + "&table=recipes_file", {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "dietician/datatables/is-active-setter?table=recipes_file&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    isCoverSetter(id) {
      this.$axios.get("https://api.klinikdiyetisyen.com/api/" + "dietician/datatables/is-cover-setter?table=recipes_file&foreign_column=recipes_id&id=" + id, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
    ...
    saveRecipes() {
      let formData = new FormData(this.$refs.recipesForm); //formData.append("dietician_id",this.userData._id);

      this.$axios.post("https://api.klinikdiyetisyen.com/api/" + "dietician/recipes/create", formData, {
        json: true,
        withCredentials: false,
        mode: "no-cors",
        headers: {
        ...
        if (response.data.success) {
          ...
          this.$refs.myDropzone.options.url = "https://api.klinikdiyetisyen.com/api/" + "dietician/recipes/create-file/" + response.data.data.$oid;
          this.$refs.myDropzone.dropzone.options.url = "https://api.klinikdiyetisyen.com/api/" + "dietician/recipes/create-file/" + response.data.data.$oid;
          this.options.url = "https://api.klinikdiyetisyen.com/api/" + "dietician/recipes/create-file/" + response.data.data.$oid;
...
// CONCATENATED MODULE: ./pages/dietician-panel/recipes/add/index.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/dietician-panel/recipes/add/index.vue
