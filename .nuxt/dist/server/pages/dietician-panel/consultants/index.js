...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dietician-panel/consultants/index.vue?vue&type=template&id=3913c6a2&
...
// CONCATENATED MODULE: ./pages/dietician-panel/consultants/index.vue?vue&type=template&id=3913c6a2&
...
/* harmony default export */ var consultantsvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${"https://api.klinikdiyetisyen.com/api/"}dietician/datatables/${urlParam}?table=users&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=dietician_id,status&where_value=${this.userData._id},!='dietician'`, {
        json: true,
...
installComponents_default()(component, {VApp: VApp["a" /* default */],VCard: VCard["a" /* default */],VCardTitle: components_VCard["d" /* VCardTitle */],VCol: VCol["a" /* default */],VDataTable: VDataTable["a" /* default */],VIcon: VIcon["a" /* default */],VPagination: VPagination["a" /* default */],VSelect: VSelect["a" /* default */],VTextField: VTextField["a" /* default */]})
