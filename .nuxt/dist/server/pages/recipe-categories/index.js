    ...
    getRecipeCategories(param) {
      if (this.search !== null) {
        this.$store.dispatch("getRecipeCategories", {
          recipeCategoriesURL: "recipe-categories?page=" + this.pagination.current + "&search=" + decodeURIComponent(this.search)
        }).then(response => {
        ...
        if (param) {
          ...
          this.$store.dispatch("getRecipeCategories", {
            recipeCategoriesURL: "recipe-categories?page=" + this.pagination.current
          }).then(response => {
            this.recipeCategories = this.$store.getters.recipeCategories.data;
            this.pagination.current = this.$store.getters.recipeCategories.current_page;
            this.pagination.total = this.$store.getters.recipeCategories.last_page;
...
// CONCATENATED MODULE: ./pages/recipe-categories/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_recipe_categoriesvue_type_script_lang_js_ = (recipe_categoriesvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/recipe-categories/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_recipe_categoriesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
installComponents_default()(component, {VApp: VApp["a" /* default */],VPagination: VPagination["a" /* default */]})
