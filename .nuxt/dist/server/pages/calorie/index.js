...
/* harmony default export */ var calorievue_type_script_lang_js_ = ({
  components: {
  ...
  methods: {
    getNutrients(param) {
      if (this.search !== null) {
        this.$store.dispatch("getNutrients", {
          nutrientsURL: "nutrients?page=" + this.pagination.current + "&search=" + decodeURIComponent(this.search)
        }).then(response => {
...
// CONCATENATED MODULE: ./pages/calorie/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_calorievue_type_script_lang_js_ = (calorievue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/calorie/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_calorievue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var calorie = __webpack_exports__["default"] = (component.exports);
