    ...
    getRecipes(param) {
      if (this.search !== null) {
        this.$store.dispatch("getRecipes", {
          recipesURL: "recipes?page=" + this.pagination.current + "&search=" + decodeURIComponent(this.search)
        }).then(response => {
