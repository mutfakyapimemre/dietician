                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 login-right">
                  ...
                  <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                      <div class="login-header">
                        <h3 class="font-weight-bold">Diyetisyen Klinik
                          ...
                          <v-stepper v-model="e1">
                            ...
                            <v-stepper-items>
                              <v-stepper-content step="1">
                                ...
                                <button class="btn btn-green-light rounded-0" role="button" type="button" @click="e1 = 2">
                                  Sonraki
                                </button>
                              </v-stepper-content>
                              ...
                              <v-stepper-content step="2">
                                <div class="form-group form-focus">
                                  <ValidationProvider name="Hastane/Poliklinik Adı" rules="required"
                                                      v-slot="{ errors }">
                                    <v-text-field
                                ...
                                <div class="form-group form-focus">
                                  <ValidationProvider name="İşyerinizin Bulunduğu İl" rules="required"
                                                      v-slot="{ errors }">
                                    <label for="company_city">İşyerinizin Bulunduğu İl</label>
                                    <select v-on:change="getTowns" name="company_city" id="company_city"
                                ...
                                <div class="form-group form-focus">
                                  <ValidationProvider name="İşyerinizin Bulunduğu İlçe" rules="required"
                                    ...
                                    <select v-on:change="getDistricts" name="company_town" id="company_town" class="form-control floating rounded-0">
                                      <option value="" v-if="country.towns.length > 0"
                                ...
                                <div class="form-group form-focus">
                                  <ValidationProvider name="İşyerinizin Bulunduğu Semt" rules="required"
                                    ...
                                    <select v-on:change="getNeighborhoods" name="company_district" id="company_district"
                                ...
                                <div class="form-group form-focus">
                                  <ValidationProvider name="İşyerinizin Bulunduğu Mahalle" rules="required"
                                    ...
                                    <select name="company_neighborhood" id="company_neighborhood" class="form-control floating rounded-0">
                                      <option value=""
                                ...
                                <div class="form-group form-focus">
                                    <input type="file" name="certificate_file" class="form-control rounded-0" placeholder="Diploma Örneği" accept="image/*,.pdf" required>
                                </div>
                                <div class="form-group form-focus">
                                    <input type="file" name="identity_file" class="form-control rounded-0" placeholder="Kimlik İle Çekilmiş Fotoğraf Örneği" accept="image/*" required>
                                </div>
                                <div class="form-group pt-3">
                                  <button class="btn btn-info-light mr-3 rounded-0 float-left" type="button" role="button"
                                          @click="e1 = 1">Geri Dön
                                  </button>
                                  <button class="btn btn-green-light rounded-0" type="submit">Kayıt Ol
                                  </button>
                                </div>
                              </v-stepper-content>
                            </v-stepper-items>
