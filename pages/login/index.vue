                  ...
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                      <div class="login-header">
                        <h3 class="font-weight-bold">
                          Diyetisyen Klinik
                          <small class="font-weight-normal">Kullanıcı Girişi</small>
                          <nuxt-link to="/dietician-login" tag="a">Diyetisyen Misiniz? Hemen Giriş Yapın</nuxt-link>
                        </h3>
                      </div>
                    ...
                    <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                      <div class="login-header">
                        <h3 class="font-weight-bold">
                          Diyetisyen Klinik
                          <small class="font-weight-normal">Kullanıcı Kaydı</small>
                          <nuxt-link to="/dietician-login" tag="a">Diyetisyen Misiniz? Hemen Kayıt Olun</nuxt-link>
                        </h3>
                      </div>
                      <ValidationObserver v-slot="{ handleSubmit }">
                        <form @submit.prevent="handleSubmit(onRegister)" ref="userRegister" enctype="multipart/form-data">
                          <div class="form-group form-focus">
                            <ValidationProvider name="Adınız ve Soyadınız" rules="required" v-slot="{ errors }">
                              <v-text-field label="Adınız ve Soyadınız" hide-details="auto" type="text" name="name" v-model="name"></v-text-field>
                              <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                            </ValidationProvider>
                          </div>
                          <div class="form-group form-focus">
                            <ValidationProvider name="Email Adresiniz" rules="required|email" v-slot="{ errors }">
                              <v-text-field label="Email Adresiniz" hide-details="auto" type="email" name="email" v-model="email"></v-text-field>
                              <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                            </ValidationProvider>
                          </div>
                          <div class="form-group form-focus">
                            <ValidationProvider name="Telefon Numaranız" rules="required|phone" v-slot="{ errors }">
                              <v-text-field label="Telefon Numaranız" hide-details="auto" type="text" name="phone" v-model="phone"></v-text-field>
                              <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                            </ValidationProvider>
                          </div>
                          <div class="form-group form-focus">
