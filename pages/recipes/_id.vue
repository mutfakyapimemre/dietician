                ...
                <div class="card-body">
                  <div class="doctor-widget">
                    <div class="doc-info-left">
                      <div class="doctor-img" v-if="data !== null && data !== '' && data !== undefined && image.isCover === 1">
                        <img
                          v-bind:key="index"
                          ...
                          <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="form-group">
                              ...
                              <select
                                ...
                                "
                              >
                                <option v-bind:value="0" selected>Ölçüt Seçiniz</option>
                                <option
                                  v-bind:key="index"
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 offset-md-3 offset-lg-3 offset-xl-3">
                          ...
                          <div class="widget business-widget">
                            <div class="widget-content">
                              <div
                                class="listing-hours"
                                v-if="data !== null && data !== undefined && data !== '' && values !== null && values !== undefined && values !== ''"
                              >
