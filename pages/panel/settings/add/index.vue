                  ...
                  <form @submit.prevent="handleSubmit(saveSettings)" ref="settingsForm" enctype="multipart/form-data">
                    <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                      ...
                      <li class="nav-item"><a class="nav-link" href="#site-analizleri" data-toggle="tab">Site
                        Analizleri</a></li>
                      <li class="nav-item"><a class="nav-link" href="#canli-destek" data-toggle="tab">Canlı Destek</a></li>
                    </ul>
...
export default {
  ...
  methods: {
    saveSettings() {
      ...
      this.$axios.post(process.env.apiBaseUrl+"panel/settings/create", formData,{
        json: true,
