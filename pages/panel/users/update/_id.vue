            ...
            <div class="card">
              ...
              <div class="card-body">
                <ValidationObserver v-slot="{ invalid,handleSubmit }">
                  <form @submit.prevent="handleSubmit(editUsers)" ref="usersForm" enctype="multipart/form-data">
...
export default {
  ...
  async asyncData({params, error, $axios}) {
    try {
      const {data} = await $axios.get(  process.env.apiBaseUrl+"panel/users/update/" + params.id)
  ...
  methods: {
    editUsers() {
      ...
      this.$axios.post(process.env.apiBaseUrl+"panel/users/update/"+ this.data._id.$oid, formData, {
        json: true,
