                  ...
                  <v-card tile>
                    <v-card-title class="d-flex justify-content-between">
                      ...
                      <span class="justify-content-end flex-shrink-1">
                        ...
                        <nuxt-link to="/panel/nutrients/add" tag="a" class="float-right btn btn-primary text-white my-auto py-auto">
...
export default {
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${process.env.apiBaseUrl}panel/nutrients/${urlParam}?table=nutrients&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,description`, {
        json: true,
    ...
    editData(id) {
      console.log(id);
      //this.$router.push({name: "/panel/nutrients/update/", params: {id: id}});

      this.$router.push("/panel/nutrients/update/" + id)
    },
    deleteData(id) {
      this.$axios.delete(process.env.apiBaseUrl + "panel/nutrients/delete/" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isActiveSetter(id){
      this.$axios.get(process.env.apiBaseUrl + "panel/datatables/is-active-setter?table=nutrients&id="+id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
