...
export default {
  ...
  methods: {
    getCriterias(){
      this.$axios.get(`${process.env.apiBaseUrl}panel/recipes/create`, {
        json: true,
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${process.env.apiBaseUrl}panel/datatables/${urlParam}?table=recipes_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=recipes_id&where_value=${this.inputData.id}&joins=recipes_file`, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    deleteData(id) {
      this.$axios.delete(process.env.apiBaseUrl + "panel/datatables/delete-file?id=" + id+"&table=recipes_file", {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get(process.env.apiBaseUrl + "panel/datatables/is-active-setter?table=recipes_file&id=" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isCoverSetter(id) {
      this.$axios.get(process.env.apiBaseUrl + "panel/datatables/is-cover-setter?table=recipes_file&foreign_column=recipes_id&id=" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    saveRecipes() {
      ...
      this.$axios.post(process.env.apiBaseUrl + "panel/recipes/create", formData, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
        ...
        .then(response => {
          if (response.data.success) {
            ...
            this.$refs.myDropzone.options.url = process.env.apiBaseUrl + "panel/recipes/create-file/" + response.data.data.$oid
            this.$refs.myDropzone.dropzone.options.url = process.env.apiBaseUrl + "panel/recipes/create-file/" + response.data.data.$oid
            this.options.url = process.env.apiBaseUrl + "panel/recipes/create-file/" + response.data.data.$oid
