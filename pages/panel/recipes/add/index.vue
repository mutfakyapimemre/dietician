                          ...
                          <v-stepper-content step="1">
                            ...
                            <ValidationProvider name="Yemek Tarifi Türü" rules="required" v-slot="{ errors }">
                              <div class="form-group">
                                ...
                                <select name="category_id" id="category_id" v-model="inputData.category_id" class="form-control">
                                  <option v-bind:value="null" selected>Yemek Tarifi Türü Seçiniz.</option>
                                  <option v-bind:key="index" v-bind:value="category._id.$oid" v-for="(category, index) in allCategories">
                                    {{ category.name }}
                                  </option>
                                </select>
                                <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                              ...
                              <v-tab-item eager>
                                <v-card flat>
                                  <v-card-text
                                    ...
                                    "
                                  >
                                    <div class="row" v-bind:key="index" v-for="(input2, index) in inputs2">
                                      <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                        <ValidationProvider v-bind:name="input2[0].label" rules="required" v-slot="{ errors }">
                                          <div class="form-group">
                                            ...
                                            <select name="criteriaName[]" v-bind:id="input2[0].id" v-model="input2[0].value" class="form-control">
                                              ...
                                              <option v-bind:value="criteria.name" v-bind:key="index" v-for="(criteria, index) in allCriterias">
                                                {{ criteria.name }}
                                              </option>
                                            </select>
                                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                        ...
                                        <ValidationProvider v-bind:name="input2[3].label" rules="required" v-slot="{ errors }">
                                          <div class="form-group">
                                            ...
                                            <select name="criteriaNutrient[]" v-bind:id="input2[3].id" v-model="input2[3].value" class="form-control">
                                              ...
                                              <option v-bind:value="nutrient._id.$oid" v-bind:key="index" v-for="(nutrient, index) in allNutrients">
                                                {{ nutrient.name }}
                                              </option>
                                            </select>
                                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                            ...
                            <button class="btn btn-outline-primary rounded-0 btn-lg" type="submit">
