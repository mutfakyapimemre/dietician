          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Yemek Tarifi Kategorileri</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <ValidationObserver v-slot="{ invalid,handleSubmit }">
                  <form @submit.prevent="handleSubmit(saveRecipeCategories)" ref="recipeCategoriesForm" enctype="multipart/form-data">
                    <v-stepper v-model="e1">
                      ...
                      <v-stepper-items>
                        <v-stepper-content step="1">
                          ...
                          <button class="btn btn-outline-primary rounded-0 btn-lg" type="submit">Yemek Tarifi Kategorisini Kayıt Et</button>
                        </v-stepper-content>
...
export default {
  ...
  methods: {
    saveRecipeCategories() {
      ...
      this.$axios.post(process.env.apiBaseUrl + "panel/recipe-categories/create", formData, {
        json: true,
        ...
        .then(response => {
          ...
          if (response.data.success) {
            ...
            this.$refs.myDropzone.options.url = process.env.apiBaseUrl + "panel/recipe-categories/create-file/" + response.data.data.$oid
            this.$refs.myDropzone.dropzone.options.url = process.env.apiBaseUrl + "panel/recipe-categories/create-file/" + response.data.data.$oid
            this.options.url = process.env.apiBaseUrl + "panel/recipe-categories/create-file/" + response.data.data.$oid
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${process.env.apiBaseUrl}panel/datatables/${urlParam}?table=recipe_categories_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=recipe_category_id&where_value=${this.inputData.id}&joins=recipe_categories_file`, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    deleteData(id) {
      this.$axios.delete(process.env.apiBaseUrl + "panel/datatables/delete-file?id=" + id+"&table=recipe_categories_file", {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get(process.env.apiBaseUrl + "panel/datatables/is-active-setter?table=recipe_categories_file&id=" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isCoverSetter(id) {
      this.$axios.get(process.env.apiBaseUrl + "panel/datatables/is-cover-setter?table=recipe_categories_file&foreign_column=recipe_category_id&id=" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
