                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        >
                                          <div class="form-group">
                                            <label v-bind:for="'diseaseType' + index"
...
export default {
  ...
  data() {
    return {
      ...
      options: {
        url:
          process.env.apiBaseUrl + "panel/diseases/create-file/" + this.$route.params.id,
        headers: {
          Authorization:
            "Bearer " +
  ...
  methods: {
    ...
    editDiseases() {
      ...
      this.$axios
        .post(
          process.env.apiBaseUrl + "panel/diseases/update/" + this.data._id.$oid,
          formData,
          {
            json: true,
            withCredentials: false,
