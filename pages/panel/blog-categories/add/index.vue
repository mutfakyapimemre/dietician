            ...
            <div class="card">
              ...
              <div class="card-body">
                <ValidationObserver v-slot="{ invalid,handleSubmit }">
                  <form @submit.prevent="handleSubmit(saveBlogCategories)" ref="blogCategoriesForm" enctype="multipart/form-data">
                    <v-stepper v-model="e1">
                      ...
                      <v-stepper-items>
                        <v-stepper-content step="1">
                          <ValidationProvider name="Makale Kategorisi Adı" rules="required" v-slot="{ errors }">
                          ...
                          <button class="btn btn-outline-primary rounded-0 btn-lg" type="submit">Ölçütü Kayıt Et</button>
                        </v-stepper-content>
...
export default {
  ...
  methods: {
    ...
    saveCriterias() {
      ...
      this.$axios.post(process.env.apiBaseUrl + "panel/criteria/create", formData, {
        json: true,
        ...
        .then(response => {
          ...
          if (response.data.success) {
            ...
            this.$refs.myDropzone.options.url = process.env.apiBaseUrl + "panel/criteria/create-file/" + response.data.data.$oid
            this.$refs.myDropzone.dropzone.options.url = process.env.apiBaseUrl + "panel/criteria/create-file/" + response.data.data.$oid
            this.options.url = process.env.apiBaseUrl + "panel/criteria/create-file/" + response.data.data.$oid
