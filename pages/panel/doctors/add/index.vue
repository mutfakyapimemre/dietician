            ...
            <div class="card">
              ...
              <div class="card-body">
                <ValidationObserver v-slot="{ invalid,handleSubmit }">
                  <form @submit.prevent="handleSubmit(saveDoctors)" ref="doctorsForm" enctype="multipart/form-data">
                    <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                      <li class="nav-item"><a class="nav-link active" href="#genel-bilgiler" data-toggle="tab">Genel
                        Bilgiler</a></li>
                      <li class="nav-item"><a class="nav-link" href="#sosyal-medya" data-toggle="tab">Sosyal Medya</a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="#is-yeri-bilgileri" data-toggle="tab">İş Yeri Bilgileri</a>
                      </li>
                    </ul>
                    <div class="tab-content mb-3">
                      <div class="tab-pane show active" id="genel-bilgiler">
                        ...
                        <ValidationProvider name="T.C. Kimlik Numaranız" rules="required" v-slot="{ errors }">
                          <div class="form-group">
                            <label for="identity">T.C. Kimlik Numaranız</label>
                            <input id="identity" type="text" class="form-control" name="identity" v-model="data.identity">
                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                          </div>
                        </ValidationProvider>
                        ...
                        <ValidationProvider name="Tekrar Şifreniz" rules="required" v-slot="{ errors }">
                          <div class="form-group">
                            ...
                            <input id="password_confirmation" type="text" class="form-control" name="password_confirmation" v-model="data.password_confirmation">
                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                          </div>
                        </ValidationProvider>
                        <ValidationProvider name="Kullanıcı Görseli" rules="required" v-slot="{ errors }">
                        <div class="form-group">
                      ...
                      <div class="tab-pane" id="is-yeri-bilgileri">
                        <ValidationProvider name="Hastane/Poliklinik Adı" rules="required" v-slot="{ errors }">
                          <div class="form-group">
                            ...
                            <input id="hospitalName" type="text" class="form-control" name="hospitalName" v-model="data.hospitalName">
                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                          </div>
                        </ValidationProvider>
                        <ValidationProvider name="Departmanınız" rules="required" v-slot="{ errors }">
                          <div class="form-group">
                            ...
                            <input id="department" type="text" class="form-control" name="department" v-model="data.department">
                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                          </div>
                        </ValidationProvider>
                        <ValidationProvider name="Telefon Numaranız" rules="required" v-slot="{ errors }">
                          <div class="form-group">
                            ...
                            <input id="work_phone" type="text" class="form-control" name="work_phone" v-model="data.work_phone">
                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                          </div>
                        </ValidationProvider>
                        <ValidationProvider name="Telefon Numaranız 2" rules="required" v-slot="{ errors }">
                          <div class="form-group">
                            ...
                            <input id="work_phone_2" type="text" class="form-control" name="work_phone_2" v-model="data.work_phone_2">
                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                          </div>
                        </ValidationProvider>
                        <ValidationProvider name="Adresiniz" rules="required" v-slot="{ errors }">
                          <div class="form-group">
                            <label for="address">Adresiniz</label>
                            <input id="address" type="text" class="form-control" name="address" v-model="data.address">
                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                          </div>
                        </ValidationProvider>
                      </div>
                    ...
                    <div class="form-group">
                      <button class="btn btn-primary login-btn text-white" type="submit">Gönder</button>
                    </div>
                  </form>
                </ValidationObserver>
...
export default {
  ...
  methods: {
    saveDoctors() {
      ...
      this.$axios.post(process.env.apiBaseUrl+"panel/doctors/create", formData,{
        json: true,
