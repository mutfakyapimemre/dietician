            ...
            <div class="card">
              ...
              <div class="card-body">
                <ValidationObserver v-slot="{ invalid,handleSubmit }">
                  <form @submit.prevent="handleSubmit(editDoctors)" ref="doctorsForm" enctype="multipart/form-data">
                      ...
                      <div class="tab-pane show active" id="genel-bilgiler">
                        ...
                        <div class="row">
                          <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                            <img v-bind:src="decodeURIComponent(siteSettings.baseURL)+'/public/storage/'+data.img_url" v-bind:alt="data.name" width="300" height="300">
                          </div>
...
export default {
  ...
  async asyncData({params, error, $axios}) {
    try {
      const {data} = await $axios.get(  process.env.apiBaseUrl+"panel/doctors/update/" + params.id)
