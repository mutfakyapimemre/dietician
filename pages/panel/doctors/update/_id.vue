                ...
                <ValidationObserver v-slot="{ handleSubmit }">
                  <form @submit.prevent="handleSubmit(editDoctors)" ref="doctorsForm" enctype="multipart/form-data">
                    <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#is-yeri-bilgileri" data-toggle="tab">İş Yeri Bilgileri</a>
                      </li>
                    </ul>
                      ...
                      <div class="tab-pane show active" id="genel-bilgiler">
                        ...
                        <ValidationProvider name="T.C. Kimlik Numaranız" rules="required" v-slot="{ errors }">
                          <div class="form-group">
                            ...
                            <input id="tc" type="text" class="form-control" name="tc" v-model="data.tc" />
                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                          </div>
                        </ValidationProvider>
                        ...
                        <div class="row">
                          <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                            <img
                              v-bind:src="decodeURIComponent(siteSettings.baseURL) + '/public/storage/' + data.img_url"
...
export default {
  ...
  methods: {
    editDoctors() {
      ...
      this.$axios
        .post(process.env.apiBaseUrl + "panel/doctors/update/" + this.data._id, formData, {
          json: true,
        ...
        .then((response) => {
          if (response.data.success) {
            ...
            setTimeout(() => {
              window.location.href = decodeURIComponent("/panel/doctors");
            }, 2000);
          } else {
            this.$izitoast.error({
              title: response.data.title,
