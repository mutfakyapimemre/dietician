            ...
            <div class="card">
              ...
              <div class="card-body">
                <ValidationObserver v-slot="{ handleSubmit }">
                  <form
                    @submit.prevent="handleSubmit(editDoctors)"
                    ref="doctorsForm"
                  ...
                  >
                    <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#is-yeri-bilgileri" data-toggle="tab"
                          >İş Yeri Bilgileri</a
                        >
                      </li>
                    </ul>
                    ...
                    <div class="form-group">
                      <button class="btn btn-primary login-btn text-white" type="submit">
                        Gönder
                      </button>
                    </div>
                  </form>
