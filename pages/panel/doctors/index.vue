            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Diyetisyenler
                  ...
                  <v-card tile>
                    <v-card-title class="d-flex justify-content-between">
                      ...
                      <span class="justify-content-end flex-shrink-1">
                        ...
                        <nuxt-link to="/panel/doctors/add" tag="a" class="float-right btn btn-primary text-white my-auto py-auto">
...
export default {
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${process.env.apiBaseUrl}panel/datatables/${urlParam}?table=doctors&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone`, {
        json: true,
    ...
    deleteData(id) {
      this.$axios.delete(process.env.apiBaseUrl + "panel/doctors/delete/" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isActiveSetter(id){
      this.$axios.get(process.env.apiBaseUrl + "panel/datatables/is-active-setter?table=doctors&id="+id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
