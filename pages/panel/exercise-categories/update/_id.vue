          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Egzersiz Kategorisi Düzenle</li>
              </ul>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${process.env.apiBaseUrl}panel/datatables/${urlParam}?table=exercise_categories_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=exercise_category_id&where_value=${this.data._id.$oid}&joins=exercise_categories_file`, {
        json: true,
    ...
    deleteData(id) {
      this.$axios.delete(process.env.apiBaseUrl + "panel/datatables/delete-file?id=" + id+"&table=exercise_categories_file", {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get(process.env.apiBaseUrl + "panel/datatables/is-active-setter?table=exercise_categories_file&id=" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isCoverSetter(id) {
      this.$axios.get(process.env.apiBaseUrl + "panel/datatables/is-cover-setter?table=exercise_categories_file&foreign_column=exercise_category_id&id=" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    editExerciseCategories() {
      ...
      this.$axios.post(process.env.apiBaseUrl + "panel/exercise-categories/update/" + this.data._id.$oid, formData, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
