            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Egzersiz Kategorileri</h4>
                </div>
                <div class="card-body">
                  <v-card tile>
...
export default {
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios
        .get(
          `${process.env.apiBaseUrl}panel/exercise-categories/${urlParam}?table=exercise_categories&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone`,
          {
            json: true,
