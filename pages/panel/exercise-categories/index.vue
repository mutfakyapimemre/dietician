            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Egzersiz Kategorileri
                  ...
                  <v-card tile>
                    <v-card-title class="d-flex justify-content-between">
                      ...
                      <span class="justify-content-end flex-shrink-1">
                        ...
                        <nuxt-link to="/panel/exercise-categories/add" tag="a" class="float-right btn btn-primary text-white my-auto py-auto">
...
export default {
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${process.env.apiBaseUrl}panel/exercise-categories/${urlParam}?table=exercise_categories&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone`, {
        json: true,
    ...
    editData(id) {
      console.log(id);
      //this.$router.push({name: "/panel/exercises/update/", params: {id: id}});

      this.$router.push("/panel/exercise-categories/update/" + id)
    },
    deleteData(id) {
      this.$axios.delete(process.env.apiBaseUrl + "panel/exercise-categories/delete/" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isActiveSetter(id){
      this.$axios.get(process.env.apiBaseUrl + "panel/datatables/is-active-setter?table=exercise_categories&id="+id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
