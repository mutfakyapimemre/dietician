                  ...
                  <v-card tile>
                    <v-card-title class="d-flex justify-content-between">
                      ...
                      <span class="justify-content-end flex-shrink-1">
                        ...
                        <nuxt-link to="/panel/slides/add" tag="a" class="float-right btn btn-primary text-white my-auto py-auto">
...
export default {
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${process.env.apiBaseUrl}panel/datatables/${urlParam}?table=sliders&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name`, {
        json: true,
    ...
    editData(id) {
      console.log(id);
      //this.$router.push({name: "/panel/slides/update/", params: {id: id}});

      this.$router.push("/panel/slides/update/" + id)
    },
    deleteData(id) {
      this.$axios.delete(process.env.apiBaseUrl + "panel/sliders/delete/" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isActiveSetter(id){
      this.$axios.get(process.env.apiBaseUrl + "panel/datatables/is-active-setter?table=sliders&id="+id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
