              ...
              <div class="card-body">
                ...
                <div class="appointment-tab">
                  ...
                  <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                    <li class="nav-item"><a class="nav-link active" href="#danisman_kayit_bilgileri" data-toggle="tab">Danışman
                      Bilgileri</a></li>
                    <li class="nav-item"><a class="nav-link" href="#danisman_kayit_bilgisi_duzenle" data-toggle="tab">Danışman
                      Bilgisi Düzenle</a>
                    </li>
                  </ul>
                  <!-- /Appointment Tab -->
                              ...
                              <div class="table-responsive mt-5">
                                <table class="table table-striped table-hover table-center table-borderless mb-0"
                                  ...
                                  <tr>
                                    <td><b>İkamet Ettiğiniz Adres :</b></td>
                                    <td colspan="2">
                                        <textarea name="address" id="dietician_address" class="form-control" cols="30"
                                                  rows="5"
                                                  v-model="data.address" disabled>{{data.address}}</textarea>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td><b>Doğum Tarihi :</b></td>
                                    <td colspan="2">
                                      <ValidationProvider name="Doğum Tarihi" rules="required"
                                        ...
                                        <input type="date" class="form-control" name="birthDate"
                                               placeholder="Doğum Tarihi" v-model="data.birthDate">
...
export default {
  ...
  methods: {
    updateInformation() {
      ...
      this.$axios.post(process.env.apiBaseUrl + "dietician/users/update/"+this.data._id.$oid, formData, {
        json: true,
