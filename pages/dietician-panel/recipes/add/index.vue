            ...
            <div class="card">
              ...
              <div class="card-body">
                <ValidationObserver v-slot="{ invalid,handleSubmit }">
                  <form @submit.prevent="handleSubmit(saveRecipes)" ref="recipesForm" enctype="multipart/form-data">
                        ...
                        <v-stepper-content step="1">
                          ...
                          <ValidationProvider name="Yemek Tarifi Porsiyon Sayısı" rules="required" v-slot="{ errors }">
                            <div class="form-group">
                              ...
                              <input id="portion" type="text" class="form-control" name="portion" v-model="inputData.portion">
                              <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                            </div>
                          </ValidationProvider>
                          <ValidationProvider name="Yemek Tarifi Hazırlık Süresi" rules="required" v-slot="{ errors }">
                            <div class="form-group">
                              ...
                              <input id="prepare_time" type="text" class="form-control" name="prepare_time" v-model="inputData.prepare_time">
                              <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                            </div>
                          </ValidationProvider>
                          <ValidationProvider name="Yemek Tarifi Hazırlık Süresi" rules="required" v-slot="{ errors }">
                            <div class="form-group">
                              ...
                              <input id="cooking_time" type="text" class="form-control" name="cooking_time" v-model="inputData.cooking_time">
                              <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                            </div>
                          </ValidationProvider>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                      <ValidationProvider v-bind:name="input[0].label" rules="required" v-slot="{ errors }">
                                        <div class="form-group">
                                          ...
                                          <input v-bind:id="input[0].id" type="text" class="form-control" name="vitaminName[]" v-model="input[0].value">
                                          <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                        </div>
                                      </ValidationProvider>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                      <ValidationProvider v-bind:name="input[1].label" rules="required" v-slot="{ errors }">
                                        <div class="form-group">
                                          ...
                                          <input v-bind:id="input[1].id" type="text" class="form-control" name="vitaminValue[]" v-model="input[1].value">
                                          <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                        </div>
                                      </ValidationProvider>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                      <ValidationProvider v-bind:name="input[2].label" rules="required" v-slot="{ errors }">
                                        <div class="form-group">
                                          ...
                                          <input v-bind:id="input[2].id" type="text" class="form-control" name="vitaminType[]" v-model="input[2].value">
                                          <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                        </div>
                                      </ValidationProvider>
                                    </div>
                              ...
                              <v-card flat>
                                <v-card-text>
                                  <div class="row" v-if="inputs2 !== null && inputs2 !== undefined && inputs2 !== '' && allCriterias !== null && allCriterias !== undefined && allCriterias !== '' > 0 && allNutrients !== null && allNutrients !== undefined && allNutrients !== ''" v-for="input2 in inputs2">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                      <ValidationProvider v-bind:name="input2[0].label" rules="required" v-slot="{ errors }">
                                        <div class="form-group">
                                          <label v-bind:for="input2[0].id">{{ input2[0].label }}</label>
                                          <select name="criteriaName[]" v-bind:id="input2[0].id" v-model="input2[0].value" class="form-control">
                                            <option value="" selected>Malzeme Ölçüt Değeri Adı Seçiniz.</option>
                                            <option v-bind:value="criteria.name" v-for="criteria in allCriterias">{{criteria.name}}</option>
                                          </select>
                                          <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                        </div>
                                      </ValidationProvider>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2">
                                      <ValidationProvider v-bind:name="input2[1].label" rules="required" v-slot="{ errors }">
                                        <div class="form-group">
                                          <label v-bind:for="input2[1].id">{{ input2[1].label }}</label>
                                          <input v-bind:id="input2[1].id" type="text" class="form-control" name="criteriaValue[]" v-model="input2[1].value">
                                          <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                        </div>
                                      </ValidationProvider>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2">
                                      <ValidationProvider v-bind:name="input2[2].label" rules="required" v-slot="{ errors }">
                                        <div class="form-group">
                                          <label v-bind:for="input2[2].id">{{ input2[2].label }}</label>
                                          <input v-bind:id="input2[2].id" type="text" class="form-control" name="criteriaType[]" v-model="input2[2].value">
                                          <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                        </div>
                                      </ValidationProvider>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2">
                                      <ValidationProvider v-bind:name="input2[3].label" rules="required" v-slot="{ errors }">
                                        <div class="form-group">
                                          <label v-bind:for="input2[3].id">{{ input2[3].label }}</label>
                                          <select name="criteriaNutrient[]" v-bind:id="input2[3].id" v-model="input2[3].value" class="form-control">
                                            <option value="" selected>Malzeme Besini Seçiniz.</option>
                                            <option v-bind:value="nutrient._id.$oid" v-for="nutrient in allNutrients">{{nutrient.name}}</option>
                                          </select>
                                          <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                        </div>
                                      </ValidationProvider>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2  py-auto my-auto text-center align-bottom">
                                      <button @click.prevent="cloneProperty2" class="btn btn-lg btn-primary text-white rounded-circle align-bottom text-center" role="button">
                                        <i class="fa fa-plus"></i></button>
                                      <button v-if="inputs2.length > 1" @click.prevent="removeProperty2(input2[0].id)" role="button" class="btn btn-lg btn-danger text-white rounded-circle align-bottom text-center">
                                        <i class="fa fa-times"></i></button>
                                    </div>
                                  </div>
                                </v-card-text>
                          ...
                          <button class="btn btn-outline-primary rounded-0 btn-lg" type="submit">Yemek Tarifini Kayıt Et, Görsel
                            Yüklemeye Geç
                          </button>
                        </v-stepper-content>
                        ...
                        <v-stepper-content step="2">
                          <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <dropzone @vdropzone-file-added="onFileAdded"
                                        @vdropzone-error="onError"
                                        @vdropzone-success="onSuccess"
                                        @vdropzone-complete="onComplete"
                                        ref="myDropzone" id="dropzone" :options="options" :headers="options.headers"></dropzone>
                            </div>
                          </div>
...
export default {
  ...
  data() {
    return {
      ...
      inputs2: [
        [{id: 'criteria0', label: 'Malzeme Ölçüt Değeri Adı', value: ''}, {id: 'criteriaValue0', label: 'Malzeme Ölçüt Değeri', value: ''},{id: 'criteriaType0', label: 'Malzeme Ölçüt Değeri Türü', value: ''},{id: 'criteriaNutrient0', label: 'Malzeme Besini', value: ''}]
      ],
      e1: 1,
      inputData: {
        name: null,
  ...
  methods: {
    getCriterias(){
      this.$axios.get(`${process.env.apiBaseUrl}dietician/recipes/create`, {
        json: true,
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${process.env.apiBaseUrl}dietician/datatables/${urlParam}?table=recipes_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=recipes_id&where_value=${this.inputData.id}&joins=recipes_file`, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    deleteData(id) {
      this.$axios.delete(process.env.apiBaseUrl + "dietician/recipes/delete-file?id=" + id+"&table=recipes_file", {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isActiveSetter(id) {
      this.$axios.get(process.env.apiBaseUrl + "dietician/datatables/is-active-setter?table=recipes_file&id=" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    isCoverSetter(id) {
      this.$axios.get(process.env.apiBaseUrl + "dietician/datatables/is-cover-setter?table=recipes_file&foreign_column=recipes_id&id=" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    saveRecipes() {
      ...
      this.$axios.post(process.env.apiBaseUrl + "dietician/recipes/create", formData, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
        ...
        .then(response => {
          if (response.data.success) {
            ...
            this.$refs.myDropzone.options.url = process.env.apiBaseUrl + "dietician/recipes/create-file/" + response.data.data.$oid
            this.$refs.myDropzone.dropzone.options.url = process.env.apiBaseUrl + "dietician/recipes/create-file/" + response.data.data.$oid
            this.options.url = process.env.apiBaseUrl + "dietician/recipes/create-file/" + response.data.data.$oid
