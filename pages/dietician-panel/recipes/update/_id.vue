                      ...
                      <v-stepper v-model="e1">
                        ...
                        <v-stepper-items>
                          <v-stepper-content step="1">
                            ...
                            <v-tabs-items v-model="tab">
                                  ...
                                  <v-card-text>
                                    <div class="row" v-if="data.values !== null && data.values !== undefined && data.values !== '' && data.values.length > 0" v-for="(input,index) in data.values">
                                      <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                        <ValidationProvider name="Besin Değeri Adı" rules="required" v-slot="{ errors }">
                                          <div class="form-group">
                                            ...
                                            <input v-bind:id="'vitamin'+index" type="text" class="form-control" name="vitaminName[]" v-model="input.title">
                                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                          </div>
                                        </ValidationProvider>
                                      </div>
                                      <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                        <ValidationProvider name="Besin Değeri" rules="required" v-slot="{ errors }">
                                          <div class="form-group">
                                            ...
                                            <input v-bind:id="'vitaminValue'+index" type="text" class="form-control" name="vitaminValue[]" v-model="input.value">
                                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                          </div>
                                        </ValidationProvider>
                                      </div>
                                      <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                        <ValidationProvider name="Besin Değeri Türü" rules="required" v-slot="{ errors }">
                                          <div class="form-group">
                                            ...
                                            <input v-bind:id="'vitaminType'+index" type="text" class="form-control" name="vitaminType[]" v-model="input.type">
                                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                          </div>
                                        </ValidationProvider>
                                      </div>
                                      <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2  py-auto my-auto text-center align-bottom">
                                        ...
                                        <button v-if="data.values.length > 1" @click.prevent="removeProperty(index)" role="button" class="btn btn-lg btn-danger text-white rounded-circle align-bottom text-center">
                              ...
                              <v-tab-item eager>
                                <v-card flat>
                                  <v-card-text>
                                    <div class="row" v-if="data.criterias !== null && data.criterias !== undefined && data.criterias !== '' && data.criterias.length > 0" v-for="(input,index) in data.recipes_criteria_values">
                                      <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                        <ValidationProvider name="Ölçüt Değeri Adı" rules="required" v-slot="{ errors }">
                                          <div class="form-group">
                                            ...
                                            <select name="criteriaName[]" v-bind:id="'criteria'+index" class="form-control">
                                              ...
                                              <option v-bind:value="criteria.name" :selected="criteria.name === input.title" v-for="criteria in data.criterias">{{criteria.name}}</option>
                                            </select>
                                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                          </div>
                                        </ValidationProvider>
                                      ...
                                      <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2">
                                        <ValidationProvider name="Ölçüt Değeri" rules="required" v-slot="{ errors }">
                                          <div class="form-group">
                                            ...
                                            <input v-bind:id="'criteriaValue'+index" type="text" class="form-control" name="criteriaValue[]" v-model="input.value">
                                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                          </div>
                                        </ValidationProvider>
                                      </div>
                                      <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2">
                                        <ValidationProvider name="Ölçüt Değeri Türü" rules="required" v-slot="{ errors }">
                                          <div class="form-group">
                                            ...
                                            <input v-bind:id="'criteriaType'+index" type="text" class="form-control" name="criteriaType[]" v-model="input.type">
                                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                          </div>
                                        </ValidationProvider>
                                      </div>
                                      <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2">
                                        <ValidationProvider name="Malzeme Besini" rules="required" v-slot="{ errors }">
                                          <div class="form-group">
                                            ...
                                            <select name="criteriaNutrient[]" v-bind:id="'criteriaNutrient'+index" v-model="input.recipe_criteria_id" class="form-control">
                                              <option value="" selected>Malzeme Besini Seçiniz.</option>
                                              <option v-bind:value="nutrient._id.$oid" :selected="nutrient._id.$oid === input.recipe_criteria_id" v-for="nutrient in data.nutrients">{{nutrient.name}}</option>
                                            </select>
                                            <small class="font-weight-bold text-danger">{{ errors[0] }}</small>
                                          </div>
                                        </ValidationProvider>
                                      ...
                                      <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2  py-auto my-auto text-center align-bottom">
                                        <button @click.prevent="cloneProperty2" class="btn btn-lg btn-primary text-white rounded-circle align-bottom text-center" role="button">
                                          <i class="fa fa-plus"></i></button>
                                        <button v-if="data.recipes_criteria_values.length > 1" @click.prevent="removeProperty2(index)" role="button" class="btn btn-lg btn-danger text-white rounded-circle align-bottom text-center">
                                          <i class="fa fa-times"></i></button>
                                      </div>
                                    </div>
                                  </v-card-text>
                            ...
                            <button class="btn btn-outline-primary rounded-0 btn-lg" role="button" @click.prevent="e1=2">Görsel
                              Yüklemeye Geç
                            </button>
                          </v-stepper-content>
                          ...
                          <v-stepper-content step="2">
                            ...
                            <button class="btn btn-outline-primary rounded-0 btn-lg" role="button" @click.prevent="e1=1">
                              Geri Dön
                            </button>
                          ...
                          <v-stepper-content step="3">
                            ...
                            <button class="btn btn-outline-primary rounded-0 btn-lg" type="submit">Besini Güncelle</button>
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      options: {
        url: process.env.apiBaseUrl + "dietician/recipes/create-file/"+this.$route.params.id,
        headers: {
  ...
  async asyncData({params, error, $axios}) {
    try {
      ...
      const {data} = await $axios.get(process.env.apiBaseUrl + "dietician/recipes/update/" + params.id)
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${process.env.apiBaseUrl}dietician/datatables/${urlParam}?table=recipes_file&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=recipes_id&where_value=${this.data._id.$oid}&joins=recipes_file`, {
        json: true,
    ...
    deleteData(id) {
      this.$axios.delete(process.env.apiBaseUrl + "dietician/recipes/delete/" + id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
    ...
    editRecipes() {
      ...
      this.$axios.post(process.env.apiBaseUrl + "dietician/recipes/update/" + this.data._id.$oid, formData, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
