            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Yemek Tarifleri
                  ...
                  <v-card tile>
                    <v-card-title class="d-flex justify-content-between">
                      ...
                      <span class="justify-content-end flex-shrink-1">
                        ...
                        <nuxt-link to="/dietician-panel/recipes/add" tag="a" class="float-right btn btn-primary text-white my-auto py-auto">
...
export default {
  ...
  methods: {
    ...
    retrieveData(url) {
      ...
      this.$axios.get(`${process.env.apiBaseUrl}dietician/recipes/${urlParam}?table=recipes&page=${params.page}&per_page=${params.size}&search=${params.title}&search_columns=name,email,phone&where_column=dietician_id&where_value=${this.userData._id}`, {
        json: true,
    ...
    isActiveSetter(id){
      this.$axios.get(process.env.apiBaseUrl + "dietician/datatables/is-active-setter?table=recipes&id="+id, {
        json: true,
        withCredentials: false,
        mode: 'no-cors',
        headers: {
