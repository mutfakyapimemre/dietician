          ...
          <div class="col-12 col-sm-12 col-md-12 col-12 col-xl-12">
            <nav aria-label="breadcrumb" class="page-breadcrumb">
              <ol class="breadcrumb pl-0">
                ...
                <li class="breadcrumb-item"><nuxt-link to="/calorie" tag="a">Kaç Kalori?</nuxt-link></li>
                ...
                <div class="doctor-widget">
                  <div class="doc-info-left">
                    <div class="doctor-img">
                      <img v-if="data!== null && data !== '' && data !== undefined && image.isCover === 1" v-for="image in images" v-bind:src="img_url+'public/storage/'+image.img_url" class="img-fluid" v-bind:alt="data.name">
                    </div>
                        ...
                        <div class="widget business-widget">
                          <div class="widget-content">
                            <div class="listing-hours">
                              ...
                              <div v-if="(data!==null && data!==undefined && data!=='' && values!==null && values!==undefined && values!=='') " v-for="(value,index) in fordata" v-bind:class="' px-2 listing-day '+ (index%2===0 ? 'bg-secondary text-white py-2' : '') ">
