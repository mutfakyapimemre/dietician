...
!function($) {
    ...
    CalendarApp.prototype.onDrop = function (eventObj, date) {
        let $this = this;
            ...
            let originalEventObject = eventObj.data('eventObject');
            let $categoryClass = eventObj.attr('data-class');
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        let $this = this;
            ...
            $this.$modal.find('form').on('submit', function () {
                ...
                let beginning = form.find("input[name='beginning']").val();
                let ending = form.find("input[name='ending']").val();
                let categoryClass = form.find("select[name='category'] option:checked").val();
    ...
    CalendarApp.prototype.init = function() {
        ...
        this.$saveCategoryBtn.on('click', function(){
            let categoryName = $this.$categoryForm.find("input[name='category-name']").val();
            let categoryColor = $this.$categoryForm.find("select[name='category-color']").val();
