...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin_includes/AdminHeader.vue?vue&type=template&id=48f28284&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"header"},[_vm._ssrNode("<div class=\"header-left\">","</div>",[_c('nuxt-link',{attrs:{"to":"/panel"}},[_c('img',{staticClass:"logo",attrs:{"src":"/img/logo.png","alt":"Diyetisyen Klinik"}})]),_vm._ssrNode(" "),_c('nuxt-link',{staticClass:"logo logo-small",attrs:{"to":"/panel"}},[_c('img',{attrs:{"src":"/img/favicon.png","alt":"Diyetisyen Klinik","width":"30","height":"30"}})])],2),_vm._ssrNode(" <a href=\"javascript:void(0);\" id=\"toggle_btn\"><i class=\"fa fa-bars\"></i></a> <a href=\"javascript:void(0)\" id=\"mobile_btn\" class=\"mobile_btn\"><i class=\"fa fa-bars\"></i></a> "),_vm._ssrNode("<ul class=\"nav user-menu\">","</ul>",[_vm._ssrNode("<li class=\"nav-item dropdown noti-dropdown\">","</li>",[_vm._ssrNode("<a href=\"javascript:void(0)\" data-toggle=\"dropdown\" class=\"dropdown-toggle nav-link\"><i class=\"fa fa-bell\"></i> <span class=\"badge badge-pill\">3</span></a> "),_vm._ssrNode("<div class=\"dropdown-menu notifications\">","</div>",[_vm._ssrNode("<div class=\"topnav-dropdown-header\"><span class=\"notification-title\">Bildirimler</span> <a href=\"javascript:void(0)\" class=\"clear-noti\"> Tümünü Temizle </a></div> <div class=\"noti-content\"><ul class=\"notification-list\"><li class=\"notification-message\"><a href=\"javascript:void(0)\"><div class=\"media\"><span class=\"avatar avatar-sm\"><img alt=\"User Image\" src=\"/img/patients/patient3.jpg\" class=\"avatar-img rounded-circle\"></span> <div class=\"media-body\"><p class=\"noti-details\"><span class=\"noti-title\">Carl Kelly</span> send a\n\t\t\t\t\t\t\t\t\t\t\tmessage <span class=\"noti-title\"> to his doctor</span></p> <p class=\"noti-time\"><span class=\"notification-time\">12 mins ago</span></p></div></div></a></li></ul></div> "),_vm._ssrNode("<div class=\"topnav-dropdown-footer\">","</div>",[_c('nuxt-link',{attrs:{"to":"/panel/notifications"}},[_vm._v("Tüm Bildirimleri Görüntüle")])],1)],2)],2),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"nav-item dropdown has-arrow\">","</li>",[_vm._ssrNode("<a href=\"javascript:void(0)\" data-toggle=\"dropdown\" class=\"dropdown-toggle nav-link\"><span class=\"user-img\"><img"+(_vm._ssrAttr("src",_vm.img_url +
								'/public/storage/' +
								(!_vm.isEmpty(_vm.userData) ? _vm.userData.img_url : null)))+" width=\"31\""+(_vm._ssrAttr("alt",!_vm.isEmpty(_vm.userData) ? _vm.userData.name : null))+" class=\"rounded-circle\"></span></a> "),_vm._ssrNode("<div class=\"dropdown-menu\">","</div>",[_vm._ssrNode("<div class=\"user-header\"><div class=\"avatar avatar-sm\"><img"+(_vm._ssrAttr("src",_vm.img_url +
									'/public/storage/' +
									(!_vm.isEmpty(_vm.userData) ? _vm.userData.img_url : null)))+(_vm._ssrAttr("alt",!_vm.isEmpty(_vm.userData) ? _vm.userData.name : null))+" class=\"avatar-img rounded-circle\"></div> <div class=\"user-text\"><h6>"+((!_vm.isEmpty(_vm.userData))?("<span>"+_vm._ssrEscape(_vm._s(_vm.userData.name))+"</span>"):"<!---->")+"</h6> <p class=\"text-muted mb-0\">Administrator</p></div></div> "),(!_vm.isEmpty(_vm.userData) && !_vm.isEmpty(_vm.userData._id))?_c('nuxt-link',{staticClass:"dropdown-item",attrs:{"to":"/profile"}},[_vm._v("Profilim")]):_vm._e(),_vm._ssrNode(" "),_c('nuxt-link',{staticClass:"dropdown-item",attrs:{"to":"/panel/settings"}},[_vm._v("Ayarlar")]),_vm._ssrNode(" <a href=\"javascript:void(0)\" class=\"dropdown-item\">Çıkış Yap</a>")],2)],2)],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/admin_includes/AdminHeader.vue?vue&type=template&id=48f28284&
...
/* harmony default export */ var AdminHeadervue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      isAuthenticated: !this.isEmpty(this.$auth.$storage.getUniversal("user")) ? this.$auth.$storage.getUniversal("user").api_token : null,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin_includes/AdminSidebar.vue?vue&type=template&id=341043e6&
...
// CONCATENATED MODULE: ./components/admin_includes/AdminSidebar.vue?vue&type=template&id=341043e6&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/admin.vue?vue&type=template&id=804635a6&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-wrapper"},[_c('AdminHeader'),_vm._ssrNode(" "),_c('AdminSidebar'),_vm._ssrNode(" "),_c('Nuxt'),_vm._ssrNode(" <div class=\"sidebar-overlay\"></div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./layouts/admin.vue?vue&type=template&id=804635a6&

// EXTERNAL MODULE: ./components/admin_includes/AdminHeader.vue + 4 modules
var AdminHeader = __webpack_require__(170);

// EXTERNAL MODULE: ./components/admin_includes/AdminSidebar.vue + 4 modules
var AdminSidebar = __webpack_require__(171);
...
installComponents(component, {AdminHeader: __webpack_require__(170).default,AdminSidebar: __webpack_require__(171).default})
