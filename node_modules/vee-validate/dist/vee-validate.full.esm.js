...
var code = "en";
var messages = {
    alpha: "{_field_} Yalnızca Harf İçerebilir.",
    alpha_dash: "{_field_} Alanı Harf ve Tire (-) ya da Alttan Tire (_) İçerebilir.",
    alpha_num: "{_field_} Yalnızca Harf ve Rakam İçerebilir.",
    alpha_spaces: "{_field_} Yalnızca Harf Boşluk (Space) İçerebilir.",
    between: "{_field_} {min} İle {max} Aralığında Olmalıdır.",
    confirmed: "{_field_} Doğrulaması Hatalı.",
    digits: "{_field_} Sayısal ve {length} Basamaklı Olmalıdır.",
    dimensions: "{_field_} Alanı {width} Piksel İle {height} Piksel Arasında Olmalıdır.",
    ...
    length: "{_field_} Alanı En Fazla {length} Uzunluğunda Olmalıdır.",
